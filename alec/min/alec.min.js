...
window.performance.now.bind(window.performance):function(){return(new Date).getTime()}}(),toHex:function(a){a=a.toString(16).toUpperCase();a.length%2&&(a="0"+a);return"0x"+a},getPrefix:function(a,b){var c=!1;void 0===b&&(b=document);a.some(function(a){return a in b?(c=a,!0):!1});return c},isIE:function(){return/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)}};function BinaryRequest(a,b,c,e,d){a=a||"GET";var h=[];if(c){var f=[],q;for(q in c){var g=encodeURI(q);void 0!==c[q]&&(g+="="+encodeURI(c[q]));f.push(g)}b+="?"+f.join("&")}var k=new XMLHttpRequest;k.open(a,b,!0);try{k.responseType="arraybuffer"}catch(m){console.error("responseType arrayBuffer not supported!")}k.onreadystatechange=function(){if(4==k.readyState){var a;for(a=0;a<h.length;++a)h[a]()}};k.onload=function(){this.response instanceof ArrayBuffer?d(this.response):console.error("Bad response type: "+
typeof this.response+" for "+JSON.stringify(this.response))};k.send(e);this.always=function(a){4==k.readyState&&a();h.push(a);return this}}function SyncWriter(){this.kBufferLength=524288;this.syncBuffer=new Uint16Array(this.kBufferLength);this.fileOffset=this.syncBufferIdx=0;this.curRequest=null;this.buffers=[]}
...
this.outputChannel[1]+this.outputChannel[2]+this.outputChannel[3];d>HI_BOUNDARY?d=HI_BOUNDARY:d<LO_BOUNDARY&&(d=LO_BOUNDARY);c[a+e]=d;this.clockFrac+=this.clock;var h=this.clockFrac>>SCALE,f=h<<SCALE;this.clockFrac-=f;this.freqCounter[0]-=h;this.freqCounter[1]-=h;this.freqCounter[2]-=h;this.freqCounter[3]=128==this.noiseFreq?this.freqCounter[2]:this.freqCounter[3]-h;for(d=0;3>d;d++){var q=this.freqCounter[d];if(0>=q){var g=this.reg[d<<1];6<g?(this.freqPos[d]=(f-this.clockFrac+(2<<SCALE)*q<<SCALE)*
this.freqPolarity[d]/(f+this.clockFrac),this.freqPolarity[d]=-this.freqPolarity[d]):(this.freqPolarity[d]=1,this.freqPos[d]=NO_ANTIALIAS);this.freqCounter[d]+=g*(h/g+1)}else this.freqPos[d]=NO_ANTIALIAS}0>=this.freqCounter[3]&&(this.freqPolarity[3]=-this.freqPolarity[3],128!=this.noiseFreq&&(this.freqCounter[3]+=this.noiseFreq*(h/this.noiseFreq+1)),1==this.freqPolarity[3]&&(d=0,d=0!==(this.reg[6]&4)?0!==(this.noiseShiftReg&FEEDBACK_PATTERN)&&0!==(this.noiseShiftReg&FEEDBACK_PATTERN^FEEDBACK_PATTERN)?
...
b+1]=this.CRAM[e+1],this.display[c+b+2]=this.CRAM[e+2]}else this.drawBGColour(a)}},drawBg:function(a){var b=0,c=0,e=0,d=0,h=this.vdpreg[8],f=ACCURATE?this.vScrollLatch:this.vdpreg[9];16>a&&0!==(this.vdpreg[0]&64)&&(h=0);var q=this.vdpreg[0]&128,g=32-(h>>3)+this.h_start,k=a+f>>3;27<k&&(k-=28);for(var f=(a+(f&7)&7)<<3,m=a<<8,l=this.h_start;l<this.h_end;l++){var b=this.bgt+((g&31)<<1)+(k<<6),p=this.VRAM[b+1],r=(p&8)<<1,s=(l<<3)+(h&7),t=0===(p&4)?f:56-f,u=this.tiles[(this.VRAM[b]&255)+((p&1)<<8)];if(0===
(p&2))for(b=0;8>b&&s<SMS_WIDTH;b++,s++)c=u[b+t],e=4*(s+m),d=3*(c+r),this.bgPriority[s]=0!==(p&16)&&0!==c,this.display[e]=this.CRAM[d],this.display[e+1]=this.CRAM[d+1],this.display[e+2]=this.CRAM[d+2];else for(b=7;0<=b&&s<SMS_WIDTH;b--,s++)c=u[b+t],e=4*(s+m),d=3*(c+r),this.bgPriority[s]=0!==(p&16)&&0!==c,this.display[e]=this.CRAM[d],this.display[e+1]=this.CRAM[d+1],this.display[e+2]=this.CRAM[d+2];g++;0!==q&&23==l&&(k=a>>3,f=(a&7)<<3)}},drawSprite:function(a){for(var b=0,c=0,e=0,d=0,h=this.lineSprites[a],
f=Math.min(SPRITES_PER_LINE,h[SPRITE_COUNT]),q=this.vdpreg[1]&1,g=a<<8,k=3*f;d<f;d++){var m=h[k--]|(this.vdpreg[6]&4)<<6,l=h[k--],p=h[k--]-(this.vdpreg[0]&8),b=a-l>>q;0!==(this.vdpreg[1]&2)&&(m&=-2);m=this.tiles[m+((b&8)>>3)];l=0;0>p&&(l=-p,p=0);var r=l+((b&7)<<3);if(0===q)for(;8>l&&p<SMS_WIDTH;l++,p++)b=m[r++],0===b||this.bgPriority[p]||(c=4*(p+g),e=3*(b+16),this.display[c]=this.CRAM[e],this.display[c+1]=this.CRAM[e+1],this.display[c+2]=this.CRAM[e+2],VDP_SPRITE_COLLISIONS&&(this.spriteCol[p]?this.status|=
STATUS_COLLISION:this.spriteCol[p]=!0));else for(;8>l&&p<SMS_WIDTH;l++,p+=2)b=m[r++],0===b||this.bgPriority[p]||(c=4*(p+g),e=3*(b+16),this.display[c]=this.CRAM[e],this.display[c+1]=this.CRAM[e+1],this.display[c+2]=this.CRAM[e+2],VDP_SPRITE_COLLISIONS&&(this.spriteCol[p]?this.status|=STATUS_COLLISION:this.spriteCol[p]=!0)),0===b||this.bgPriority[p+1]||(c=4*(p+g+1),e=3*(b+16),this.display[c]=this.CRAM[e],this.display[c+1]=this.CRAM[e+1],this.display[c+2]=this.CRAM[e+2],VDP_SPRITE_COLLISIONS&&(this.spriteCol[p+
...
window.$&&($.fn.JSSMSUI=function(a){var b=this,c=function(c){function d(a){return function(b){f.main.keyboard.controller1&=~a;b.preventDefault()}}function h(a){return function(b){f.main.keyboard.controller1|=a;b.preventDefault()}}this.main=c;var f=this;c=$("<div></div>");var q=$('<div id="screen"></div>'),g=$('<div class="gamepad"><div class="direction"><div class="up"></div><div class="right"></div><div class="left"></div><div class="down"></div></div><div class="buttons"><div class="start"></div><div class="fire1"></div><div class="fire2"></div></div></div>'),k=
$('<div id="controls"></div>');JSSMS.Utils.getPrefix(["fullscreenEnabled","mozFullScreenEnabled"]);var m=JSSMS.Utils.getPrefix(["requestAnimationFrame","mozRequestAnimationFrame"],window),l;this.requestAnimationFrame=window[m].bind(window);this.screen=$("<canvas width="+SMS_WIDTH+" height="+SMS_HEIGHT+" moz-opaque></canvas>");this.canvasContext=this.screen[0].getContext("2d");this.canvasContext.mozImageSmoothingEnabled=!1;this.canvasContext.imageSmoothingEnabled=!1;this.canvasImageData=this.canvasContext.getImageData(0,
0,SMS_WIDTH,SMS_HEIGHT);this.gamepad={u:{e:$(".up",g),k:KEY_UP},r:{e:$(".right",g),k:KEY_RIGHT},d:{e:$(".down",g),k:KEY_DOWN},l:{e:$(".left",g),k:KEY_LEFT},1:{e:$(".fire1",g),k:KEY_FIRE1},2:{e:$(".fire2",g),k:KEY_FIRE2}};m=$(".start",g);$("#play").click(function(a){f.main.romFileName?f.main.isRunning?(f.main.stop(),f.updateStatus("Paused"),$("#play span").removeClass("icon-pause").addClass("icon-play")):(f.main.start(),$("#play span").removeClass("icon-play").addClass("icon-pause")):a.preventDefault()});
var p="",r=new FileReader;r.onload=function(a){f.loadROMFile(a.target.result,p)};$("#romUpload").change(function(){if(0!==document.getElementById("romUpload").files.length){var a=document.getElementById("romUpload").files[0];p=a.name;r.readAsBinaryString(a)}});this.romSelect=$("#romSelector").change(function(){f.loadROM()});$("#fullscreen").click(function(){var a=q[0];a.requestFullscreen?a.requestFullscreen():a.mozRequestFullScreen()});this.screen.appendTo(q);g.appendTo(q);q.appendTo(c);k.appendTo(c);
c.appendTo($(b));void 0!==a&&this.setRoms(a);$(document).bind("keydown",function(a){f.main.keyboard.keydown(a)}).bind("keyup",function(a){f.main.keyboard.keyup(a)});for(l in this.gamepad)this.gamepad[l].e.on("mousedown touchstart",d(this.gamepad[l].k)).on("mouseup touchend",h(this.gamepad[l].k));m.on("mousedown touchstart",function(a){f.main.is_sms?f.main.pause_button=!0:f.main.keyboard.ggstart&=-129;a.preventDefault()}).on("mouseup touchend",function(a){f.main.is_sms||(f.main.keyboard.ggstart|=128);
a.preventDefault()})};c.prototype={reset:function(){this.screen[0].width=SMS_WIDTH;this.screen[0].height=SMS_HEIGHT},setRoms:function(a){var b,c,f,q,g=0;this.romSelect.children().remove();$("<option></option>").appendTo(this.romSelect);for(b in a){if(a.hasOwnProperty(b)){c=$("<optgroup></optgroup>").attr("label",b);f=a[b].length;for(q=0;q<f;q++)$("<option>"+a[b][q][0]+"</option>").attr("value",a[b][q][1]).appendTo(c);c.appendTo(this.romSelect)}g++}},loadROM:function(){var a=this;this.updateStatus("Downloading...");
$.ajax({url:encodeURI(this.romSelect.val()),xhr:function(){var b=$.ajaxSettings.xhr();void 0!==b.overrideMimeType&&b.overrideMimeType("text/plain; charset=x-user-defined");return a.xhr=b},complete:function(b,c){var f;"error"==c?alert("The selected ROM file could not be loaded."):(f=b.responseText,a.loadROMFile(f,a.romSelect.val()))}})},loadROMFile:function(a,b){this.main.stop();this.main.readRomDirectly(a,b);this.main.reset();this.main.vdp.forceFullRedraw();this.enable();$("#play").removeClass("disabled");
$("#fullscreen").removeClass("disabled")},enable:function(){},updateStatus:function(){},writeAudio:function(a){},writeFrame:function(){var a=JSSMS.Utils.getPrefix(["hidden","mozHidden"]);return a?function(){document[a]||this.canvasContext.putImageData(this.canvasImageData,0,0)}:function(){this.canvasContext.putImageData(this.canvasImageData,0,0)}}(),updateDisassembly:function(a){for(var b=this.main.cpu.instructions,c=b.length,f="",q=8>a?0:a-8,g=0;16>g&&q<=c;q++)b[q]&&(f+="<div"+(b[q].address==a?' class="current"':
"")+">"+b[q].hexAddress+(b[q].isJumpTarget?":":" ")+"<code>"+b[q].inst+"</code></div>",g++);this.dissambler.html(f)}};return c});var IO_TR_DIRECTION=0,IO_TH_DIRECTION=1,IO_TR_OUTPUT=2,IO_TH_OUTPUT=3,IO_TH_INPUT=4,PORT_A=0,PORT_B=5;JSSMS.Ports=function(a){this.main=a;this.vdp=a.vdp;this.psg=a.psg;this.keyboard=a.keyboard;this.europe=64;this.hCounter=0;this.ioPorts=[]};
...
this.vdp.line;e>-this.Y_RANGE&&e<this.Y_RANGE&&c>-this.X_RANGE&&c<this.X_RANGE?(this.setTH(PORT_A,!1),a!=this.getTH(PORT_A)&&(this.hCounter=20+(this.keyboard.lightgunX>>1))):(this.setTH(PORT_A,!0),a!=this.getTH(PORT_A)&&(this.hCounter=b))},setDomestic:function(a){this.europe=a?64:0},isDomestic:function(){return 0!==this.europe}};var Bytecode=function(){function a(a,b){this.address=a;this.page=b;this.opcode=[];this.target=this.nextAddress=this.operand=null;this.isJumpTarget=this.canEnd=this.isFunctionEnder=!1;this.jumpTargetNb=0;this.ast=null}var b=JSSMS.Utils.toHex;a.prototype={get hexOpcode(){return this.opcode.length?this.opcode.map(b).join(" "):""},get label(){var a=this.name?this.name.replace(/(nn|n|PC\+e|d)/,b(this.target||this.operand||0)):"";return b(this.address+this.page*PAGE_SIZE)+" "+this.hexOpcode+" "+a}};return a}();var Parser=function(){function a(a,c){c.page=a.page;c.seek(a.address+16384*c.page);var d=c.getUint8(),g=null,k=null,m=!1,l=!1;a.opcode.push(d);switch(d){case 0:break;case 1:g=c.getUint16();break;case 2:break;case 3:break;case 4:break;case 5:break;case 6:g=c.getUint8();break;case 7:break;case 8:break;case 9:break;case 10:break;case 11:break;case 12:break;case 13:break;case 14:g=c.getUint8();break;case 15:break;case 16:k=c.position+c.getInt8();l=!0;break;case 17:g=c.getUint16();break;case 18:break;
case 19:break;case 20:break;case 21:break;case 22:g=c.getUint8();break;case 23:break;case 24:k=c.position+c.getInt8();c.seek(null);m=!0;break;case 25:break;case 26:break;case 27:break;case 28:break;case 29:break;case 30:g=c.getUint8();break;case 31:break;case 32:k=c.position+c.getInt8();l=!0;break;case 33:g=c.getUint16();break;case 34:g=c.getUint16();break;case 35:break;case 36:break;case 37:break;case 38:g=c.getUint8();break;case 39:break;case 40:k=c.position+c.getInt8();l=!0;break;case 41:break;
case 42:g=c.getUint16();break;case 43:break;case 44:break;case 45:break;case 46:g=c.getUint8();break;case 47:break;case 48:k=c.position+c.getInt8();l=!0;break;case 49:g=c.getUint16();break;case 50:g=c.getUint16();break;case 51:break;case 52:break;case 53:break;case 54:g=c.getUint8();break;case 55:break;case 56:k=c.position+c.getInt8();l=!0;break;case 57:break;case 58:g=c.getUint16();break;case 59:break;case 60:break;case 61:break;case 62:g=c.getUint8();break;case 63:break;case 64:break;case 65:break;
...
case 198:g=c.getUint8();break;case 199:k=0;m=!0;break;case 200:l=!0;break;case 201:c.seek(null);m=!0;break;case 202:k=c.getUint16();l=!0;break;case 203:return d=c.getUint8(),a.opcode.push(d),a.nextAddress=c.position,a;case 204:k=c.getUint16();l=!0;break;case 205:k=c.getUint16();m=!0;break;case 206:g=c.getUint8();break;case 207:k=8;m=!0;break;case 208:l=!0;break;case 209:break;case 210:k=c.getUint16();l=!0;break;case 211:g=c.getUint8();break;case 212:k=c.getUint16();l=!0;break;case 213:break;case 214:g=
c.getUint8();break;case 215:k=16;m=!0;break;case 216:l=!0;break;case 217:break;case 218:k=c.getUint16();l=!0;break;case 219:g=c.getUint8();break;case 220:k=c.getUint16();l=!0;break;case 221:return b(a,c);case 222:g=c.getUint8();break;case 223:k=24;m=!0;break;case 224:l=!0;break;case 225:break;case 226:k=c.getUint16();l=!0;break;case 227:break;case 228:k=c.getUint16();l=!0;break;case 229:break;case 230:g=c.getUint8();break;case 231:k=32;m=!0;break;case 232:l=!0;break;case 233:c.seek(null);m=!0;break;
case 234:k=c.getUint16();l=!0;break;case 235:break;case 236:k=c.getUint16();l=!0;break;case 237:d=c.getUint8();k=g=null;l=m=!1;a.opcode.push(d);switch(d){case 64:break;case 65:break;case 66:break;case 67:g=c.getUint16();break;case 68:case 76:case 84:case 92:case 100:case 108:case 116:case 124:break;case 69:case 77:case 85:case 93:case 101:case 109:case 117:case 125:c.seek(null);m=!0;break;case 70:case 78:case 102:case 110:break;case 71:break;case 72:break;case 73:break;case 74:break;case 75:g=c.getUint16();
break;case 79:break;case 80:break;case 81:break;case 82:break;case 83:g=c.getUint16();break;case 86:case 118:break;case 87:break;case 88:break;case 89:break;case 90:break;case 91:g=c.getUint16();break;case 95:break;case 96:break;case 97:break;case 98:break;case 99:g=c.getUint16();break;case 103:break;case 104:break;case 105:break;case 106:break;case 107:g=c.getUint16();break;case 111:break;case 113:break;case 114:break;case 115:g=c.getUint16();break;case 120:break;case 121:break;case 122:break;case 123:g=
c.getUint16();break;case 160:break;case 161:break;case 162:break;case 163:break;case 168:break;case 169:break;case 170:break;case 171:break;case 176:k=c.position-2;l=!0;break;case 177:k=c.position-2;l=!0;break;case 178:k=c.position-2;l=!0;break;case 179:k=c.position-2;l=!0;break;case 184:break;case 185:break;case 186:k=c.position-2;l=!0;break;case 187:k=c.position-2;l=!0;break;default:JSSMS.Utils.console.error("Unexpected opcode","0xED "+e(d))}a.nextAddress=c.position;a.operand=g;a.target=k;a.isFunctionEnder=
m;a.canEnd=l;return a;case 238:g=c.getUint8();break;case 239:k=40;m=!0;break;case 240:l=!0;break;case 241:break;case 242:k=c.getUint16();l=!0;break;case 243:break;case 244:k=c.getUint16();l=!0;break;case 245:break;case 246:g=c.getUint8();break;case 247:k=48;m=!0;break;case 248:l=!0;break;case 249:break;case 250:k=c.getUint16();l=!0;break;case 251:break;case 252:k=c.getUint16();l=!0;break;case 253:return b(a,c);case 254:g=c.getUint8();break;case 255:k=56;m=!0;break;default:JSSMS.Utils.console.error("Unexpected opcode",
e(d))}a.nextAddress=c.position;a.operand=g;a.target=k;a.isFunctionEnder=m;a.canEnd=l;return a}function b(a,b){var c=b.getUint8(),d=null,k=!1;a.opcode.push(c);switch(c){case 9:break;case 25:break;case 33:d=b.getUint16();break;case 34:d=b.getUint16();break;case 35:break;case 36:break;case 37:break;case 38:d=b.getUint8();break;case 41:break;case 42:d=b.getUint16();break;case 43:break;case 44:break;case 45:break;case 46:d=b.getUint8();break;case 52:d=b.getUint8();break;case 53:d=b.getUint8();break;case 54:d=
...
"0xDD/0xFD "+e(c))}a.nextAddress=b.position;a.operand=d;a.isFunctionEnder=k;return a}function c(a){this.rom=a;this.pos=null;this.page=0}var e=JSSMS.Utils.toHex,d=function(a,b){this.stream=new c(a);this.frameReg=b;this.addresses=Array(a.length);this.entryPoints=[];this.bytecodes=Array(a.length);for(var e=0;e<a.length;e++)this.addresses[e]=[],this.bytecodes[e]=[]};d.prototype={addEntryPoint:function(a){this.entryPoints.push(a);this.addAddress(a.address)},parse:function(b){JSSMS.Utils.console.time("Parsing");
var c,d;void 0===b?(c=0,d=this.stream.length-1):(c=0,d=16383);for(b=0;b<this.addresses.length;b++)for(;this.addresses[b].length;){var g=this.addresses[b].shift().address%16384;if(g<c||g>d)JSSMS.Utils.console.error("Address out of bound",e(g));else if(!this.bytecodes[b][g]){var k=new Bytecode(g,b);this.bytecodes[b][g]=a(k,this.stream);null!==this.bytecodes[b][g].nextAddress&&this.bytecodes[b][g].nextAddress>=c&&this.bytecodes[b][g].nextAddress<=d&&this.addAddress(this.bytecodes[b][g].nextAddress);
null!==this.bytecodes[b][g].target&&this.bytecodes[b][g].target>=c&&this.bytecodes[b][g].target<=d&&this.addAddress(this.bytecodes[b][g].target)}}this.bytecodes[0][1023]?this.bytecodes[0][1023].isFunctionEnder=!0:this.bytecodes[0][1022]&&(this.bytecodes[0][1022].isFunctionEnder=!0);c=d=c=0;for(d=this.entryPoints.length;c<d;c++)b=this.entryPoints[c].address,g=this.entryPoints[c].romPage,this.bytecodes[g][b].isJumpTarget=!0,this.bytecodes[g][b].jumpTargetNb++;for(b=0;b<this.bytecodes.length;b++)for(c=
0,d=this.bytecodes[b].length;c<d;c++)this.bytecodes[b][c]&&(null!==this.bytecodes[b][c].nextAddress&&this.bytecodes[b][this.bytecodes[b][c].nextAddress]&&this.bytecodes[b][this.bytecodes[b][c].nextAddress].jumpTargetNb++,null!==this.bytecodes[b][c].target&&(g=~~(this.bytecodes[b][c].target/16384),k=this.bytecodes[b][c].target%16384,this.bytecodes[g]&&this.bytecodes[g][k]?(this.bytecodes[g][k].isJumpTarget=!0,this.bytecodes[g][k].jumpTargetNb++):JSSMS.Utils.console.log("Invalid target address",e(this.bytecodes[b][c].target))));
