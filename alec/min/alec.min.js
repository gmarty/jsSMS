...
b-=512);var c,e,d=Math.round(b/PAGE_SIZE),f=Array(d);for(c=0;c<d;c++)if(f[c]=JSSMS.Utils.Array(PAGE_SIZE),SUPPORT_DATAVIEW)for(e=0;e<PAGE_SIZE;e++)f[c].setUint8(e,a.charCodeAt(c*PAGE_SIZE+e));else for(e=0;e<PAGE_SIZE;e++)f[c][e]=a.charCodeAt(c*PAGE_SIZE+e)&255;return f},reloadRom:function(){return""!=this.romData&&""!=this.romFileName?this.readRomDirectly(this.romData,this.romFileName):!1}};(function(){"console"in window?"bind"in window.console.log||(window.console.log=function(a){return function(b){return a(b)}}(window.console.log),window.console.error=function(a){return function(b){return a(b)}}(window.console.error)):window.console={log:function(){},error:function(){}}})();
...
window.performance.now.bind(window.performance):function(){return(new Date).getTime()}}(),toHex:function(a){a=a.toString(16).toUpperCase();a.length%2&&(a="0"+a);return"0x"+a},getPrefix:function(a,b){var c=!1;void 0==b&&(b=document);a.some(function(a){return a in b?(c=a,!0):!1});return c},isIE:function(){return/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)}};function BinaryRequest(a,b,c,e,d){a=a||"GET";var f=[];if(c){var k=[],q;for(q in c){var h=escape(q);void 0!=c[q]&&(h+="="+escape(c[q]));k.push(h)}b+="?"+k.join("&")}var g=new XMLHttpRequest;g.open(a,b,!0);try{g.responseType="arraybuffer"}catch(m){console.error("responseType arrayBuffer not supported!")}g.onreadystatechange=function(){if(4==g.readyState){var a;for(a=0;a<f.length;++a)f[a]()}};g.onload=function(){this.response instanceof ArrayBuffer?d(this.response):console.error("Bad response type: "+
typeof this.response+" for "+JSON.stringify(this.response))};g.send(e);this.always=function(a){4==g.readyState&&a();f.push(a);return this}}function SyncWriter(){this.kBufferLength=524288;this.syncBuffer=new Uint16Array(this.kBufferLength);this.fileOffset=this.syncBufferIdx=0;this.curRequest=null;this.buffers=[]}
...
64)|((a^b)&(b^c)&32768)>>13;this.h=c>>8&255;this.l=c&255},incR:function(){this.r=this.r&128|this.r+1&127},generateFlagTables:function(){var a,b,c,e,d,f,k;for(a=0;256>a;a++)b=0!=(a&128)?F_SIGN:0,c=0==a?F_ZERO:0,e=a&32,d=a&8,f=this.getParity(a)?F_PARITY:0,this.SZ_TABLE[a]=b|c|e|d,this.SZP_TABLE[a]=b|c|e|d|f,this.SZHV_INC_TABLE[a]=b|c|e|d,this.SZHV_INC_TABLE[a]|=128==a?F_OVERFLOW:0,this.SZHV_INC_TABLE[a]|=0==(a&15)?F_HALFCARRY:0,this.SZHV_DEC_TABLE[a]=b|c|e|d|F_NEGATIVE,this.SZHV_DEC_TABLE[a]|=127==
a?F_OVERFLOW:0,this.SZHV_DEC_TABLE[a]|=15==(a&15)?F_HALFCARRY:0,this.SZ_BIT_TABLE[a]=0!=a?a&128:F_ZERO|F_PARITY,this.SZ_BIT_TABLE[a]|=e|d|F_HALFCARRY;a=0;b=65536;c=0;e=65536;for(f=0;256>f;f++)for(k=0;256>k;k++)d=k-f,this.SZHVC_ADD_TABLE[a]=0!=k?0!=(k&128)?F_SIGN:0:F_ZERO,this.SZHVC_ADD_TABLE[a]|=k&(F_BIT5|F_BIT3),(k&15)<(f&15)&&(this.SZHVC_ADD_TABLE[a]|=F_HALFCARRY),k<f&&(this.SZHVC_ADD_TABLE[a]|=F_CARRY),0!=((d^f^128)&(d^k)&128)&&(this.SZHVC_ADD_TABLE[a]|=F_OVERFLOW),a++,d=k-f-1,this.SZHVC_ADD_TABLE[b]=
0!=k?0!=(k&128)?F_SIGN:0:F_ZERO,this.SZHVC_ADD_TABLE[b]|=k&(F_BIT5|F_BIT3),(k&15)<=(f&15)&&(this.SZHVC_ADD_TABLE[b]|=F_HALFCARRY),k<=f&&(this.SZHVC_ADD_TABLE[b]|=F_CARRY),0!=((d^f^128)&(d^k)&128)&&(this.SZHVC_ADD_TABLE[b]|=F_OVERFLOW),b++,d=f-k,this.SZHVC_SUB_TABLE[c]=0!=k?0!=(k&128)?F_NEGATIVE|F_SIGN:F_NEGATIVE:F_NEGATIVE|F_ZERO,this.SZHVC_SUB_TABLE[c]|=k&(F_BIT5|F_BIT3),(k&15)>(f&15)&&(this.SZHVC_SUB_TABLE[c]|=F_HALFCARRY),k>f&&(this.SZHVC_SUB_TABLE[c]|=F_CARRY),0!=((d^f)&(f^k)&128)&&(this.SZHVC_SUB_TABLE[c]|=
F_OVERFLOW),c++,d=f-k-1,this.SZHVC_SUB_TABLE[e]=0!=k?0!=(k&128)?F_NEGATIVE|F_SIGN:F_NEGATIVE:F_NEGATIVE|F_ZERO,this.SZHVC_SUB_TABLE[e]|=k&(F_BIT5|F_BIT3),(k&15)>=(f&15)&&(this.SZHVC_SUB_TABLE[e]|=F_HALFCARRY),k>=f&&(this.SZHVC_SUB_TABLE[e]|=F_CARRY),0!=((d^f)&(f^k)&128)&&(this.SZHVC_SUB_TABLE[e]|=F_OVERFLOW),e++},getParity:function(a){var b=!0,c;for(c=0;8>c;c++)0!=(a&1<<c)&&(b=!b);return b},generateMemory:function(){if(SUPPORT_DATAVIEW)for(var a=0;8192>a;a++)this.memWriteMap.setUint8(a,0);else for(a=
...
b>>24&255;this.exBC();this.exDE();this.exHL()}};var KEY_UP=1,KEY_DOWN=2,KEY_LEFT=4,KEY_RIGHT=8,KEY_FIRE1=16,KEY_FIRE2=32,KEY_START=64;JSSMS.Keyboard=function(a){this.main=a;this.lightgunY=this.lightgunX=this.ggstart=this.controller2=this.controller1=0;this.lightgunEnabled=this.lightgunClick=!1};
...
this.outputChannel[1]+this.outputChannel[2]+this.outputChannel[3];d>HI_BOUNDARY?d=HI_BOUNDARY:d<LO_BOUNDARY&&(d=LO_BOUNDARY);c[a+e]=d;this.clockFrac+=this.clock;var f=this.clockFrac>>SCALE,k=f<<SCALE;this.clockFrac-=k;this.freqCounter[0]-=f;this.freqCounter[1]-=f;this.freqCounter[2]-=f;this.freqCounter[3]=128==this.noiseFreq?this.freqCounter[2]:this.freqCounter[3]-f;for(d=0;3>d;d++){var q=this.freqCounter[d];if(0>=q){var h=this.reg[d<<1];6<h?(this.freqPos[d]=(k-this.clockFrac+(2<<SCALE)*q<<SCALE)*
this.freqPolarity[d]/(k+this.clockFrac),this.freqPolarity[d]=-this.freqPolarity[d]):(this.freqPolarity[d]=1,this.freqPos[d]=NO_ANTIALIAS);this.freqCounter[d]+=h*(f/h+1)}else this.freqPos[d]=NO_ANTIALIAS}0>=this.freqCounter[3]&&(this.freqPolarity[3]=-this.freqPolarity[3],128!=this.noiseFreq&&(this.freqCounter[3]+=this.noiseFreq*(f/this.noiseFreq+1)),1==this.freqPolarity[3]&&(d=0,d=0!=(this.reg[6]&4)?0!=(this.noiseShiftReg&FEEDBACK_PATTERN)&&0!=(this.noiseShiftReg&FEEDBACK_PATTERN^FEEDBACK_PATTERN)?
...
b+1]=this.CRAM[e+1],this.display[c+b+2]=this.CRAM[e+2]}else this.drawBGColour(a)}},drawBg:function(a){var b=0,c=0,e=0,d=0,f=this.vdpreg[8],k=ACCURATE?this.vScrollLatch:this.vdpreg[9];16>a&&0!=(this.vdpreg[0]&64)&&(f=0);var q=this.vdpreg[0]&128,h=32-(f>>3)+this.h_start,g=a+k>>3;27<g&&(g-=28);for(var k=(a+(k&7)&7)<<3,m=a<<8,l=this.h_start;l<this.h_end;l++){var b=this.bgt+((h&31)<<1)+(g<<6),p=this.VRAM[b+1],s=(p&8)<<1,r=(l<<3)+(f&7),t=0==(p&4)?k:56-k,u=this.tiles[(this.VRAM[b]&255)+((p&1)<<8)];if(0==
(p&2))for(b=0;8>b&&r<SMS_WIDTH;b++,r++)c=u[b+t],e=4*(r+m),d=3*(c+s),this.bgPriority[r]=0!=(p&16)&&0!=c,this.display[e]=this.CRAM[d],this.display[e+1]=this.CRAM[d+1],this.display[e+2]=this.CRAM[d+2];else for(b=7;0<=b&&r<SMS_WIDTH;b--,r++)c=u[b+t],e=4*(r+m),d=3*(c+s),this.bgPriority[r]=0!=(p&16)&&0!=c,this.display[e]=this.CRAM[d],this.display[e+1]=this.CRAM[d+1],this.display[e+2]=this.CRAM[d+2];h++;0!=q&&23==l&&(g=a>>3,k=(a&7)<<3)}},drawSprite:function(a){for(var b=0,c=0,e=0,d=0,f=this.lineSprites[a],
k=Math.min(SPRITES_PER_LINE,f[SPRITE_COUNT]),q=this.vdpreg[1]&1,h=a<<8,g=3*k;d<k;d++){var m=f[g--]|(this.vdpreg[6]&4)<<6,l=f[g--],p=f[g--]-(this.vdpreg[0]&8),b=a-l>>q;0!=(this.vdpreg[1]&2)&&(m&=-2);m=this.tiles[m+((b&8)>>3)];l=0;0>p&&(l=-p,p=0);var s=l+((b&7)<<3);if(0==q)for(;8>l&&p<SMS_WIDTH;l++,p++)b=m[s++],0==b||this.bgPriority[p]||(c=4*(p+h),e=3*(b+16),this.display[c]=this.CRAM[e],this.display[c+1]=this.CRAM[e+1],this.display[c+2]=this.CRAM[e+2],VDP_SPRITE_COLLISIONS&&(this.spriteCol[p]?this.status|=
STATUS_COLLISION:this.spriteCol[p]=!0));else for(;8>l&&p<SMS_WIDTH;l++,p+=2)b=m[s++],0==b||this.bgPriority[p]||(c=4*(p+h),e=3*(b+16),this.display[c]=this.CRAM[e],this.display[c+1]=this.CRAM[e+1],this.display[c+2]=this.CRAM[e+2],VDP_SPRITE_COLLISIONS&&(this.spriteCol[p]?this.status|=STATUS_COLLISION:this.spriteCol[p]=!0)),0==b||this.bgPriority[p+1]||(c=4*(p+h+1),e=3*(b+16),this.display[c]=this.CRAM[e],this.display[c+1]=this.CRAM[e+1],this.display[c+2]=this.CRAM[e+2],VDP_SPRITE_COLLISIONS&&(this.spriteCol[p+
1]?this.status|=STATUS_COLLISION:this.spriteCol[p+1]=!0))}f[SPRITE_COUNT]>=SPRITES_PER_LINE&&(this.status|=STATUS_OVERFLOW)},drawBGColour:function(a){a<<=8;var b=4*(a+4*SMS_WIDTH),c=3*((this.vdpreg[7]&15)+16);for(a*=4;a<b;a+=4)this.display[a]=this.CRAM[c],this.display[a+1]=this.CRAM[c+1],this.display[a+2]=this.CRAM[c+2]},decodeTiles:function(){for(var a=this.minDirty;a<=this.maxDirty;a++)if(this.isTileDirty[a]){this.isTileDirty[a]=0;for(var b=this.tiles[a],c=0,e=a<<5,d=0;d<TILE_SIZE;d++)for(var f=
this.VRAM[e++],k=this.VRAM[e++],q=this.VRAM[e++],h=this.VRAM[e++],g=128;0!=g;g>>=1){var m=0;0!=(f&g)&&(m|=1);0!=(k&g)&&(m|=2);0!=(q&g)&&(m|=4);0!=(h&g)&&(m|=8);b[c++]=m}}this.minDirty=TOTAL_TILES;this.maxDirty=-1},decodeSat:function(){this.isSatDirty=!1;for(var a=0;a<this.lineSprites.length;a++)this.lineSprites[a][SPRITE_COUNT]=0;a=0==(this.vdpreg[1]&2)?8:16;1==(this.vdpreg[1]&1)&&(a<<=1);for(var b=0;64>b;b++){var c=this.VRAM[this.sat+b]&255;if(208==c)break;c++;240<c&&(c-=256);for(var e=c;e<SMS_HEIGHT;e++)if(e-
c<a){var d=this.lineSprites[e];if(!d||d[SPRITE_COUNT]>=SPRITES_PER_LINE)break;var f=3*d[SPRITE_COUNT]+SPRITE_X,k=this.sat+(b<<1)+128;d[f++]=this.VRAM[k++]&255;d[f++]=c;d[f++]=this.VRAM[k]&255;d[SPRITE_COUNT]++}}},createCachedImages:function(){for(var a=0;a<TOTAL_TILES;a++)this.tiles[a]=new JSSMS.Utils.Uint8Array(TILE_SIZE*TILE_SIZE)},generateConvertedPals:function(){var a,b,c,e;for(a=0;64>a;a++)b=a&3,c=a>>2&3,e=a>>4&3,this.main_JAVA_R[a]=85*b&255,this.main_JAVA_G[a]=85*c&255,this.main_JAVA_B[a]=85*
...
window.$&&($.fn.JSSMSUI=function(a){var b=this,c=function(c){this.main=c;var d=this;c=$("<div></div>");var f=$('<div id="screen"></div>'),k=$('<div class="gamepad"><div class="direction"><div class="up"></div><div class="right"></div><div class="left"></div><div class="down"></div></div><div class="buttons"><div class="start"></div><div class="fire1"></div><div class="fire2"></div></div></div>'),q=$('<div id="controls"></div>');JSSMS.Utils.getPrefix(["fullscreenEnabled","mozFullScreenEnabled"]);var h=
JSSMS.Utils.getPrefix(["requestAnimationFrame","mozRequestAnimationFrame"],window),g;this.requestAnimationFrame=window[h].bind(window);this.screen=$("<canvas width="+SMS_WIDTH+" height="+SMS_HEIGHT+" moz-opaque></canvas>");this.canvasContext=this.screen[0].getContext("2d");this.canvasContext.mozImageSmoothingEnabled=!1;this.canvasContext.imageSmoothingEnabled=!1;this.canvasImageData=this.canvasContext.getImageData(0,0,SMS_WIDTH,SMS_HEIGHT);this.gamepad={u:{e:$(".up",k),k:KEY_UP},r:{e:$(".right",k),
k:KEY_RIGHT},d:{e:$(".down",k),k:KEY_DOWN},l:{e:$(".left",k),k:KEY_LEFT},1:{e:$(".fire1",k),k:KEY_FIRE1},2:{e:$(".fire2",k),k:KEY_FIRE2}};h=$(".start",k);$("#play").click(function(a){if(!d.main.romFileName)return a.preventDefault(),!1;d.main.isRunning?(d.main.stop(),d.updateStatus("Paused"),$("#play span").removeClass("icon-pause").addClass("icon-play")):(d.main.start(),$("#play span").removeClass("icon-play").addClass("icon-pause"))});var m="",l=new FileReader;l.onload=function(a){d.loadROMFile(a.target.result,
m)};$("#romUpload").change(function(){if(0!=document.getElementById("romUpload").files.length){var a=document.getElementById("romUpload").files[0];m=a.name;l.readAsBinaryString(a)}});this.romSelect=$("#romSelector").change(function(){d.loadROM()});$("#fullscreen").click(function(){var a=f[0];a.requestFullscreen?a.requestFullscreen():a.mozRequestFullScreen()});this.screen.appendTo(f);k.appendTo(f);f.appendTo(c);q.appendTo(c);c.appendTo($(b));void 0!=a&&this.setRoms(a);$(document).bind("keydown",function(a){d.main.keyboard.keydown(a)}).bind("keyup",
function(a){d.main.keyboard.keyup(a)});for(g in this.gamepad)this.gamepad[g].e.on("mousedown touchstart",function(a){return function(b){d.main.keyboard.controller1&=~a;b.preventDefault()}}(this.gamepad[g].k)).on("mouseup touchend",function(a){return function(b){d.main.keyboard.controller1|=a;b.preventDefault()}}(this.gamepad[g].k));h.on("mousedown touchstart",function(a){d.main.is_sms?d.main.pause_button=!0:d.main.keyboard.ggstart&=-129;a.preventDefault()}).on("mouseup touchend",function(a){d.main.is_sms||
(d.main.keyboard.ggstart|=128);a.preventDefault()})};c.prototype={reset:function(){this.screen[0].width=SMS_WIDTH;this.screen[0].height=SMS_HEIGHT},setRoms:function(a){var b,c,k,q,h=0;this.romSelect.children().remove();$("<option></option>").appendTo(this.romSelect);for(b in a){if(a.hasOwnProperty(b)){c=$("<optgroup></optgroup>").attr("label",b);k=a[b].length;for(q=0;q<k;q++)$("<option>"+a[b][q][0]+"</option>").attr("value",a[b][q][1]).appendTo(c);c.appendTo(this.romSelect)}h++}},loadROM:function(){var a=
...
$("#play").removeClass("disabled");$("#fullscreen").removeClass("disabled")},enable:function(){},updateStatus:function(){},writeAudio:function(a){},writeFrame:function(){var a=JSSMS.Utils.getPrefix(["hidden","mozHidden"]);return a?function(){document[a]||this.canvasContext.putImageData(this.canvasImageData,0,0)}:function(){this.canvasContext.putImageData(this.canvasImageData,0,0)}}(),updateDisassembly:function(a){for(var b=this.main.cpu.instructions,c=b.length,k="",q=8>a?0:a-8,h=0;16>h&&q<=c;q++)b[q]&&
(k+="<div"+(b[q].address==a?' class="current"':"")+">"+b[q].hexAddress+(b[q].isJumpTarget?":":" ")+"<code>"+b[q].inst+"</code></div>",h++);this.dissambler.html(k)}};return c});var IO_TR_DIRECTION=0,IO_TH_DIRECTION=1,IO_TR_OUTPUT=2,IO_TH_OUTPUT=3,IO_TH_INPUT=4,PORT_A=0,PORT_B=5;JSSMS.Ports=function(a){this.main=a;this.vdp=a.vdp;this.psg=a.psg;this.keyboard=a.keyboard;this.europe=64;this.hCounter=0;this.ioPorts=[]};
...
c<this.X_RANGE?(this.setTH(PORT_A,!1),a!=this.getTH(PORT_A)&&(this.hCounter=20+(this.keyboard.lightgunX>>1))):(this.setTH(PORT_A,!0),a!=this.getTH(PORT_A)&&(this.hCounter=b))},setDomestic:function(a){this.europe=a?64:0},isDomestic:function(){return 0!=this.europe}};var Bytecode=function(){function a(a,b){this.address=a;this.page=b;this.opcode=[];this.target=this.nextAddress=this.operand=null;this.isJumpTarget=this.canEnd=this.isFunctionEnder=!1;this.jumpTargetNb=0;this.ast=null}var b=JSSMS.Utils.toHex;a.prototype={get hexOpcode(){return this.opcode.length?this.opcode.map(b).join(" "):""},get label(){var a=this.name?this.name.replace(/(nn|n|PC\+e|d)/,b(this.target||this.operand||0)):"";return b(this.address+this.page*PAGE_SIZE)+" "+this.hexOpcode+" "+a}};return a}();var Parser=function(){function a(a,c){c.page=a.page;c.seek(a.address+16384*c.page);var d=c.getUint8(),h=null,g=null,m=!1,l=!1;a.opcode.push(d);switch(d){case 0:break;case 1:h=c.getUint16();break;case 2:break;case 3:break;case 4:break;case 5:break;case 6:h=c.getUint8();break;case 7:break;case 8:break;case 9:break;case 10:break;case 11:break;case 12:break;case 13:break;case 14:h=c.getUint8();break;case 15:break;case 16:g=c.position+c.getInt8();l=!0;break;case 17:h=c.getUint16();break;case 18:break;
case 19:break;case 20:break;case 21:break;case 22:h=c.getUint8();break;case 23:break;case 24:g=c.position+c.getInt8();c.seek(null);m=!0;break;case 25:break;case 26:break;case 27:break;case 28:break;case 29:break;case 30:h=c.getUint8();break;case 31:break;case 32:g=c.position+c.getInt8();l=!0;break;case 33:h=c.getUint16();break;case 34:h=c.getUint16();break;case 35:break;case 36:break;case 37:break;case 38:h=c.getUint8();break;case 39:break;case 40:g=c.position+c.getInt8();l=!0;break;case 41:break;
case 42:h=c.getUint16();break;case 43:break;case 44:break;case 45:break;case 46:h=c.getUint8();break;case 47:break;case 48:g=c.position+c.getInt8();l=!0;break;case 49:h=c.getUint16();break;case 50:h=c.getUint16();break;case 51:break;case 52:break;case 53:break;case 54:h=c.getUint8();break;case 55:break;case 56:g=c.position+c.getInt8();l=!0;break;case 57:break;case 58:h=c.getUint16();break;case 59:break;case 60:break;case 61:break;case 62:h=c.getUint8();break;case 63:break;case 64:break;case 65:break;
...
case 198:h=c.getUint8();break;case 199:g=0;m=!0;break;case 200:l=!0;break;case 201:c.seek(null);m=!0;break;case 202:g=c.getUint16();l=!0;break;case 203:return d=c.getUint8(),a.opcode.push(d),a.nextAddress=c.position,a;case 204:g=c.getUint16();l=!0;break;case 205:g=c.getUint16();m=!0;break;case 206:h=c.getUint8();break;case 207:g=8;m=!0;break;case 208:l=!0;break;case 209:break;case 210:g=c.getUint16();l=!0;break;case 211:h=c.getUint8();break;case 212:g=c.getUint16();l=!0;break;case 213:break;case 214:h=
c.getUint8();break;case 215:g=16;m=!0;break;case 216:l=!0;break;case 217:break;case 218:g=c.getUint16();l=!0;break;case 219:h=c.getUint8();break;case 220:g=c.getUint16();l=!0;break;case 221:return b(a,c);case 222:h=c.getUint8();break;case 223:g=24;m=!0;break;case 224:l=!0;break;case 225:break;case 226:g=c.getUint16();l=!0;break;case 227:break;case 228:g=c.getUint16();l=!0;break;case 229:break;case 230:h=c.getUint8();break;case 231:g=32;m=!0;break;case 232:l=!0;break;case 233:c.seek(null);m=!0;break;
case 234:g=c.getUint16();l=!0;break;case 235:break;case 236:g=c.getUint16();l=!0;break;case 237:d=c.getUint8();g=h=null;l=m=!1;a.opcode.push(d);switch(d){case 64:break;case 65:break;case 66:break;case 67:h=c.getUint16();break;case 68:case 76:case 84:case 92:case 100:case 108:case 116:case 124:break;case 69:case 77:case 85:case 93:case 101:case 109:case 117:case 125:c.seek(null);m=!0;break;case 70:case 78:case 102:case 110:break;case 71:break;case 72:break;case 73:break;case 74:break;case 75:h=c.getUint16();
...
c.getUint16();break;case 160:break;case 161:break;case 162:break;case 163:break;case 168:break;case 169:break;case 170:break;case 171:break;case 176:g=c.position-2;l=!0;break;case 177:g=c.position-2;l=!0;break;case 178:g=c.position-2;l=!0;break;case 179:g=c.position-2;l=!0;break;case 184:break;case 185:break;case 186:g=c.position-2;l=!0;break;case 187:g=c.position-2;l=!0;break;default:JSSMS.Utils.console.error("Unexpected opcode","0xED "+e(d))}a.nextAddress=c.position;a.operand=h;a.target=g;a.isFunctionEnder=
m;a.canEnd=l;return a;case 238:h=c.getUint8();break;case 239:g=40;m=!0;break;case 240:l=!0;break;case 241:break;case 242:g=c.getUint16();l=!0;break;case 243:break;case 244:g=c.getUint16();l=!0;break;case 245:break;case 246:h=c.getUint8();break;case 247:g=48;m=!0;break;case 248:l=!0;break;case 249:break;case 250:g=c.getUint16();l=!0;break;case 251:break;case 252:g=c.getUint16();l=!0;break;case 253:return b(a,c);case 254:h=c.getUint8();break;case 255:g=56;m=!0;break;default:JSSMS.Utils.console.error("Unexpected opcode",
e(d))}a.nextAddress=c.position;a.operand=h;a.target=g;a.isFunctionEnder=m;a.canEnd=l;return a}function b(a,b){var c=b.getUint8(),d=null,g=!1;a.opcode.push(c);switch(c){case 9:break;case 25:break;case 33:d=b.getUint16();break;case 34:d=b.getUint16();break;case 35:break;case 36:break;case 37:break;case 38:d=b.getUint8();break;case 41:break;case 42:d=b.getUint16();break;case 43:break;case 44:break;case 45:break;case 46:d=b.getUint8();break;case 52:d=b.getUint8();break;case 53:d=b.getUint8();break;case 54:d=
...
case 158:d=b.getUint8();break;case 164:break;case 165:break;case 166:d=b.getUint8();break;case 172:break;case 173:break;case 174:d=b.getUint8();break;case 180:break;case 181:break;case 182:d=b.getUint8();break;case 188:break;case 189:break;case 190:d=b.getUint8();break;case 203:return c=b.getUint8(),d=b.getUint8(),a.opcode.push(d),a.nextAddress=b.position,a.operand=c,a;case 225:break;case 227:break;case 229:break;case 233:b.seek(null);g=!0;break;case 249:break;default:JSSMS.Utils.console.error("Unexpected opcode",
"0xDD/0xFD "+e(c))}a.nextAddress=b.position;a.operand=d;a.isFunctionEnder=g;return a}function c(a){this.rom=a;this.pos=null;this.page=0}var e=JSSMS.Utils.toHex,d=function(a,b){this.stream=new c(a);this.frameReg=b;this.addresses=Array(a.length);this.entryPoints=[];this.bytecodes=Array(a.length);for(var d=0;d<a.length;d++)this.addresses[d]=[],this.bytecodes[d]=[]};d.prototype={addEntryPoint:function(a){this.entryPoints.push(a);this.addAddress(a.address)},parse:function(b){JSSMS.Utils.console.time("Parsing");
var c,d;void 0==b?(c=0,d=this.stream.length-1):(c=0,d=16383);for(b=0;b<this.addresses.length;b++)for(;this.addresses[b].length;){var h=this.addresses[b].shift().address%16384;if(h<c||h>d)JSSMS.Utils.console.error("Address out of bound",e(h));else if(!this.bytecodes[b][h]){var g=new Bytecode(h,b);this.bytecodes[b][h]=a(g,this.stream);null!=this.bytecodes[b][h].nextAddress&&(this.bytecodes[b][h].nextAddress>=c&&this.bytecodes[b][h].nextAddress<=d)&&this.addAddress(this.bytecodes[b][h].nextAddress);
...
0,d=this.bytecodes[b].length;c<d;c++)this.bytecodes[b][c]&&(null!=this.bytecodes[b][c].nextAddress&&this.bytecodes[b][this.bytecodes[b][c].nextAddress]&&this.bytecodes[b][this.bytecodes[b][c].nextAddress].jumpTargetNb++,null!=this.bytecodes[b][c].target&&(h=~~(this.bytecodes[b][c].target/16384),g=this.bytecodes[b][c].target%16384,this.bytecodes[h]&&this.bytecodes[h][g]?(this.bytecodes[h][g].isJumpTarget=!0,this.bytecodes[h][g].jumpTargetNb++):JSSMS.Utils.console.log("Invalid target address",e(this.bytecodes[b][c].target))));
JSSMS.Utils.console.timeEnd("Parsing")},parseFromAddress:function(b){var c=b.address%16384;b=b.romPage;var d=16384*b,e=16384*(b+1),g=[],m,l=!0,p=0;1024>c&&0==b&&(d=0,e=1024);do{this.bytecodes[b][c]?m=this.bytecodes[b][c]:(m=new Bytecode(c,b),this.bytecodes[b][c]=a(m,this.stream));if(m.canEnd&&!l)break;c=m.nextAddress%16384;g.push(m);l=!1;p=c+16384*b}while(null!=c&&p>=d&&p<e&&!m.isFunctionEnder);return g},writeGraphViz:function(){JSSMS.Utils.console.time("DOT generation");for(var a=this.bytecodes,
...
function generateIndexCBFunctions(a){return function(b,c,e){return void 0==e?function(d,e,k){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("location"),n.BinaryExpression("&",n.BinaryExpression("+",n.CallExpression("get"+(b+c).toUpperCase()),n.Literal(d)),n.Literal(65535)))),n.ExpressionStatement(n.CallExpression("writeMem",[n.Identifier("location"),n.CallExpression(a,o.READ_MEM8(n.Identifier("location")))]))]}:function(d,f,k){return[n.ExpressionStatement(n.AssignmentExpression("=",
