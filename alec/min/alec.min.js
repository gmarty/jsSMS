...
Ua(d));d.c++;break;case 83:F=d.p(d.c+1);d.e(F++,d.i);d.e(F,d.k);d.c+=3;break;case 86:case 118:d.M=1;d.c++;break;case 87:d.a=d.T;d.b=d.b&1|d.ja[d.a]|(d.F?4:0);d.c++;break;case 88:d.i=Jb(d.u,d.f);d.b=d.b&1|d.l[d.i];d.c++;break;case 89:U(d.u,d.f,d.i);d.c++;break;case 90:yc(d,Ua(d));d.c++;break;case 91:var bc=d,cc=d.p(d.p(d.c+1));bc.k=cc>>8;bc.i=cc&255;d.c+=3;break;case 95:d.a=Math.round(255*Math.random());d.b=d.b&1|d.ja[d.a]|(d.F?4:0);d.c++;break;case 96:d.h=Jb(d.u,d.f);d.b=d.b&1|d.l[d.h];d.c++;break;
...
case 255:Hb(a,a.c),a.c=56}var bb;if(bb=0>=b.n){var D=b;if(D.o.va){var Da=D.o,ec=D.Q;0==ec&&(Da.fa=0);for(var fc=Da.ca[ec],p=Da.c,Fc=Da.fa,gc=[],rb=0,A=0;rb<fc;rb++){for(A=0;3>A;A++)p.l[A]=p.g[A]!=qa?Ac[p.b[(A<<1)+1]]*p.g[A]>>8:Ac[p.b[(A<<1)+1]]*p.d[A];p.l[3]=Ac[p.b[7]]*(p.f&1)<<1;var Va=p.l[0]+p.l[1]+p.l[2]+p.l[3];127<Va?Va=127:-128>Va&&(Va=-128);gc[Fc+rb]=Va;p.e+=p.m;var Ea=p.e>>8,tb=Ea<<8;p.e-=tb;p.a[0]-=Ea;p.a[1]-=Ea;p.a[2]-=Ea;p.a[3]=128==p.h?p.a[2]:p.a[3]-Ea;for(A=0;3>A;A++){var hc=p.a[A];if(0>=
hc){var ub=p.b[A<<1];6<ub?(p.g[A]=(tb-p.e+512*hc<<8)*p.d[A]/(tb+p.e),p.d[A]=-p.d[A]):(p.d[A]=1,p.g[A]=qa);p.a[A]+=ub*(Ea/ub+1)}else p.g[A]=qa}if(0>=p.a[3]&&(p.d[3]=-p.d[3],128!=p.h&&(p.a[3]+=p.h*(Ea/p.h+1)),1==p.d[3])){var ic=0,ic=0!=(p.b[6]&4)?0!=(p.f&9)&&0!=(p.f&9^9)?1:0:p.f&1;p.f=p.f>>1|ic<<15}}Da.ea=gc;Da.fa+=fc}D.B.p=D.Q;if(192>D.Q){var k=D.B,V=D.Q,Na=0,cb=0,db=0;if(!k.o.V||!(24>V||168<=V))if(0!=(k.c[1]&64)){if(-1!=k.n){for(var Oa=k.r;Oa<=k.n;Oa++)if(k.u[Oa]){k.u[Oa]=n;for(var Gc=k.D[Oa],Hc=
...
Hb(z,z.c),0==z.M?(z.c=0==z.N||255==z.N?56:z.N,z.n-=13):1==z.M?(z.c=56,z.n-=13):(z.c=z.p((z.T<<8)+z.N),z.n-=19))}D.Q++;if(D.Q>=D.o.R){var X=D;X.o.Z&&(X.F=X.D,X.D=n,X.L&&(X.c++,X.L=n),Hb(X,X.c),X.c=102,X.n-=11,X.o.Z=n);X.o.a.Aa();bb=h}else D.n+=D.o.ta,bb=n}if(bb)break}this.a.requestAnimationFrame(this.wa.bind(this),this.a.screen)}},ua:function(b,a){0!=a%1024&&(b=b.substr(512),a-=512);var e,l,s=Math.round(a/16384),u=Array(s);for(e=0;e<s;e++){u[e]=new DataView(new ArrayBuffer(16384));for(l=0;16384>l;l++)u[e].setUint8(l,
...
Array(131072);this.w=Array(131072);this.S=Array(256);var a,e,l,s,u,m;for(b=0;256>b;b++)a=0!=(b&128)?128:0,e=0==b?64:0,l=b&32,s=b&8,u=Pc(b)?4:0,this.ja[b]=a|e|l|s,this.l[b]=a|e|l|s|u,this.J[b]=a|e|l|s,this.J[b]|=128==b?4:0,this.J[b]|=0==(b&15)?16:0,this.I[b]=a|e|l|s|2,this.I[b]|=127==b?4:0,this.I[b]|=15==(b&15)?16:0,this.S[b]=0!=b?b&128:68,this.S[b]|=l|s|16;b=0;a=65536;e=0;l=65536;for(u=0;256>u;u++)for(m=0;256>m;m++)s=m-u,this.z[b]=0!=m?0!=(m&128)?128:0:64,this.z[b]|=m&40,(m&15)<(u&15)&&(this.z[b]|=
...
pa.prototype={reset:function(){this.c=this.pa=this.b=this.T=this.r=this.t=this.q=this.s=this.h=this.j=this.qa=this.ra=this.k=this.i=this.na=this.oa=this.g=this.f=this.la=this.ma=this.a=this.ka=0;this.m=57328;this.M=this.n=0;this.F=this.D=n;this.N=0;this.L=n},call:function(b){b?(Hb(this,this.c+2),this.c=this.p(this.c),this.n-=7):this.c+=2},e:function(b,a){65535>=b&&(this.W.setInt8(b&8191,a),65532==b?this.A[3]=a:65533==b?this.A[0]=a&this.aa:65534==b?this.A[1]=a&this.aa:65535==b&&(this.A[2]=a&this.aa))},
...
"mozRequestAnimationFrame"],window),ha;this.requestAnimationFrame=window[E].bind(window);this.screen=$("<canvas width=256 height=192 moz-opaque></canvas>");this.X=this.screen[0].getContext("2d");this.X.mozImageSmoothingEnabled=n;this.X.imageSmoothingEnabled=n;this.sa=this.X.getImageData(0,0,256,192);this.ha={Da:{i:$(".up",m),U:1},Ca:{i:$(".right",m),U:8},k:{i:$(".down",m),U:2},j:{i:$(".left",m),U:4},1:{i:$(".fire1",m),U:16},2:{i:$(".fire2",m),U:32}};E=$(".start",m);$("#play").click(function(a){if(!s.o.za)return a.preventDefault(),
n;s.o.Y?(s.o.stop(),s.updateStatus("Paused"),$("#play span").removeClass("icon-pause").addClass("icon-play")):(s.o.start(),$("#play span").removeClass("icon-play").addClass("icon-pause"))});var R="",Ha=new FileReader;Ha.onload=function(a){s.ya(a.target.result,R)};$("#romUpload").change(function(){if(0!=document.getElementById("romUpload").files.length){var a=document.getElementById("romUpload").files[0];R=a.name;Ha.readAsBinaryString(a)}});this.ba=$("#romSelector").change(function(){s.ua()});$("#fullscreen").click(function(){var a=
u[0];a.requestFullscreen?a.requestFullscreen():a.mozRequestFullScreen()});this.screen.appendTo(u);m.appendTo(u);u.appendTo(a);t.appendTo(a);a.appendTo($(e));b!=aa&&this.Ba(b);$(document).bind("keydown",function(a){s.o.C.keydown(a)}).bind("keyup",function(a){s.o.C.keyup(a)});for(ha in this.ha)this.ha[ha].i.on("mousedown touchstart",function(a){return function(b){s.o.C.v&=~a;b.preventDefault()}}(this.ha[ha].U)).on("mouseup touchend",function(a){return function(b){s.o.C.v|=a;b.preventDefault()}}(this.ha[ha].U));
E.on("mousedown touchstart",function(a){s.o.P?s.o.Z=h:s.o.C.K&=-129;a.preventDefault()}).on("mouseup touchend",function(a){s.o.P||(s.o.C.K|=128);a.preventDefault()})}var e=this;a.prototype={reset:function(){this.screen[0].width=256;this.screen[0].height=192},Ba:function(a){var b,e,m,t,E=0;this.ba.children().remove();$("<option></option>").appendTo(this.ba);for(b in a){if(a.hasOwnProperty(b)){e=$("<optgroup></optgroup>").attr("label",b);m=a[b].length;for(t=0;t<m;t++)$("<option>"+a[b][t][0]+"</option>").attr("value",
a[b][t][1]).appendTo(e);e.appendTo(this.ba)}E++}},ua:function(){var a=this;this.updateStatus("Downloading...");$.ajax({url:escape(this.ba.val()),xhr:function(){var b=$.ajaxSettings.xhr();b.overrideMimeType!=aa&&b.overrideMimeType("text/plain; charset=x-user-defined");return a.xhr=b},complete:function(b,e){var m;"error"==e?alert("The selected ROM file could not be loaded."):(m=b.responseText,a.ya(m,a.ba.val()))}})},ya:function(a,b){this.o.stop();var e=this.o,m,t=".gg"==b.substr(-3).toLowerCase()?2:
...
function(){document[a]||this.X.putImageData(this.sa,0,0)}:function(){this.X.putImageData(this.sa,0,0)}}()};return a});function na(b){this.o=b;this.B=b.B;this.b=b.c;this.C=b.C;this.a=[]}na.prototype={reset:function(){this.a=Array(2)}};
