...
UpdateExpression:function(a,b,c){void 0==c&&(c=!1);return{type:"UpdateExpression",operator:a,argument:b,prefix:c}},MemberExpression:function(a,b){return{type:"MemberExpression",computed:!0,object:a,property:b}},ConditionalExpression:function(a,b,c){return{type:"ConditionalExpression",test:a,consequent:b,alternate:c}},Register:function(a){return{type:"Register",name:a}},Bit:function(a){return n.Literal(BIT_TABLE[a])}},o={NOOP:function(){return function(){}},LD8:function(a,b,c){return void 0==b&&void 0==
c?function(b){return n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.Literal(b)))}:"i"==b&&void 0==c?function(){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.Register("i"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("f"),n.BinaryExpression("|",n.BinaryExpression("|",n.BinaryExpression("&",n.Register("f"),n.Literal(F_CARRY)),n.MemberExpression(n.Identifier("SZ_TABLE"),n.Register(a))),n.ConditionalExpression(n.Identifier("iff2"),n.Literal(F_PARITY),
n.Literal(0)))))]}:"r"==b&&void 0==c?function(){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),REFRESH_EMULATION?n.Register("r"):n.CallExpression("JSSMS.Utils.rndInt",n.Literal(255)))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("f"),n.BinaryExpression("|",n.BinaryExpression("|",n.BinaryExpression("&",n.Register("f"),n.Literal(F_CARRY)),n.MemberExpression(n.Identifier("SZ_TABLE"),n.Register(a))),n.ConditionalExpression(n.Identifier("iff2"),n.Literal(F_PARITY),
n.Literal(0)))))]}:void 0==c?function(){return n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.Register(b)))}:"n"==b&&"n"==c?function(b){return n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),o.READ_MEM8(n.Literal(b))))}:function(){return n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),o.READ_MEM8(n.CallExpression("get"+(b+c).toUpperCase()))))}},LD8_D:function(a,b,c){return function(d){return n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),
o.READ_MEM8(n.BinaryExpression("+",n.CallExpression("get"+(b+c).toUpperCase()),n.Literal(d)))))}},LD16:function(a,b,c,d){if(void 0==c&&void 0==d)return function(c){return n.ExpressionStatement(n.CallExpression("set"+(a+b).toUpperCase(),n.Literal(c)))};if("n"==c&&"n"==d)return function(c){return n.ExpressionStatement(n.CallExpression("set"+(a+b).toUpperCase(),o.READ_MEM16(n.Literal(c))))};throw Error("Wrong parameters number");},LD_WRITE_MEM:function(a,b,c,d){return void 0==c&&void 0==d?function(c){return n.ExpressionStatement(n.CallExpression("writeMem",
...
n.Register(c)]))}},LD_SP:function(a,b){return void 0==a&&void 0==b?function(a){return n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("sp"),n.Literal(a)))}:function(){return n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("sp"),n.CallExpression("get"+(a+b).toUpperCase())))}},LD_NN:function(a,b){return void 0==b?function(b){return[n.ExpressionStatement(n.CallExpression("writeMem",n.Literal(b),n.BinaryExpression("&",n.Identifier(a),n.Literal(255)))),n.ExpressionStatement(n.CallExpression("writeMem",
...
n.Register("f"),n.Literal(F_PARITY))),n.ReturnStatement()]),n.BlockStatement([n.ExpressionStatement(n.AssignmentExpression("&=",n.Register("f"),n.UnaryExpression("~",n.Literal(F_PARITY))))])),n.ExpressionStatement(n.AssignmentExpression("&=",n.Register("f"),n.UnaryExpression("~",n.Literal(F_NEGATIVE)))),n.ExpressionStatement(n.AssignmentExpression("&=",n.Register("f"),n.UnaryExpression("~",n.Literal(F_HALFCARRY))))]}},OTIR:function(){return function(a,b,c){return[n.ExpressionStatement(n.AssignmentExpression("=",
...
a.property.type&&b[a.property.name]&&"a"==a.property.name)&&(a.property=c[a.property.name]);return a});return a})}};var whitelist=["temp","location","JSSMS.Utils.rndInt"],Generator=function(){this.ast=[]};
