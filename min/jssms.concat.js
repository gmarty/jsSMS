...
if (typeof $ !== 'undefined') {
  $.fn.JSSMSUI = function(roms) {
    ...
    var UI = function(sms) {
      ...
      self.sound = new DynamicAudio({'swf': this.main.opts['swfPath'] + 'dynamicaudio.swf'});
    };
...
DynamicAudio.prototype = {nextId: null, swf: 'dynamicaudio.swf', audioElement: null, flashWrapper: null, flashElement: null, init: function(opts) {
  var self = this;
  ...
  swfobject.embedSWF(self.swf, self.flashElement.id, '8', '8', '9.0.0', null, null, {'allowScriptAccess': 'always'}, null, function(e) {
