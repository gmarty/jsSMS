...
case 128:return this.H.Ic();case 129:return this.H.Dc();case 192:return this.Ba.C;case 193:return this.Ba.B&63|this.ja[0]|this.ja[1]}return 255}};function J(a){if(this instanceof J)"function"===typeof this.Db&&this.Db.apply(this,a&&a.callee?a:arguments);else return new arguments.callee(arguments)}var K=1;
...
document.body.appendChild(b.gb);swfobject.embedSWF(b.xc,b.ga.id,"8","8","9.0.0",i,i,{allowScriptAccess:"always"},i,function(a){b.ga=a.Id})},write:function(a){if(this.ra!==i)this.ra.mozWriteAudio(a);else if(this.ga!==i){for(var b=Array(a.length),c=a.length-1;0!==c;c--)b[c]=Math.floor(32768*a[c]);this.ga.write(b.join(" "))}},Hd:function(a){if(this.ra!==i){for(var b=Array(a.length),c=a.length-1;0!==c;c--)b[c]=a[c]/128;try{this.ra.mozWriteAudio(b)}catch(e){console.log(e,b)}}else this.ga!==i&&this.ga.write(a.join(" "))}};window.JSSMS=r;jQuery.fn.JSSMSUI=jQuery.fn.Ac;
