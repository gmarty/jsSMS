...
(this.zoomed=!1,this.buttons.zoom=$('<input type="button" value="Zoom in" class="btn hidden-phone">').click(function(){d.zoomed?(d.screen.animate({width:SMS_WIDTH+"px",height:SMS_HEIGHT+"px"},function(){$(this).removeAttr("style")}),d.buttons.zoom.attr("value","Zoom in")):(d.screen.animate({width:2*SMS_WIDTH+"px",height:2*SMS_HEIGHT+"px"}),d.buttons.zoom.attr("value","Zoom out"));d.zoomed=!d.zoomed}));for(m in this.buttons)this.buttons[m].appendTo(f);this.log=$('<div id="status"></div>');this.screen.appendTo(g);
h.appendTo(g);g.appendTo(c);this.romContainer.appendTo(c);f.appendTo(c);this.log.appendTo(c);c.appendTo($(b));void 0!=a&&this.setRoms(a);$(document).bind("keydown",function(a){d.main.keyboard.keydown(a)}).bind("keyup",function(a){d.main.keyboard.keyup(a)});for(m in this.gamepad)this.gamepad[m].e.on("mousedown touchstart",function(a){return function(b){d.main.keyboard.controller1&=~a;b.preventDefault()}}(this.gamepad[m].k)).on("mouseup touchend",function(a){return function(b){d.main.keyboard.controller1|=
...
n.Register(b)))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register("f"),n.BinaryExpression("|",n.BinaryExpression("&",n.Register("f"),n.Literal(F_CARRY)),n.MemberExpression(n.Identifier("SZP_TABLE"),n.Register(a)))))]}},EX_AF:function(){return function(){return o.EX("a","f")}},EXX:function(){return function(){return[].concat(o.EX("b","c"),o.EX("d","e"),o.EX("h","l"))}},EX_SP_HL:function(){return function(){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("temp"),n.Register("h"))),
n.ExpressionStatement(n.AssignmentExpression("=",n.Register("h"),o.READ_MEM8(n.BinaryExpression("+",n.Identifier("sp"),n.Literal(1))))),n.ExpressionStatement(n.CallExpression("writeMem",[n.BinaryExpression("+",n.Identifier("sp"),n.Literal(1)),n.Identifier("temp")])),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("temp"),n.Register("l"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register("l"),o.READ_MEM8(n.Identifier("sp")))),n.ExpressionStatement(n.CallExpression("writeMem",
[n.Identifier("sp"),n.Identifier("temp")]))]}},EX_DE_HL:function(){return function(){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("temp"),n.Register("d"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register("d"),n.Register("h"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register("h"),n.Identifier("temp"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("temp"),n.Register("e"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register("e"),
n.Register("l"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register("l"),n.Identifier("temp")))]}},HALT:function(){return function(a,b,c){a=[];HALT_SPEEDUP&&a.push(n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("tstates"),n.Literal(0))));return a.concat([n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("halt"),n.Literal(!0))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("pc"),n.BinaryExpression("+",n.Literal((c-1)%16384),n.BinaryExpression("*",
