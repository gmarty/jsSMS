...
c)}this.P[b]=a}break;case 3:this.r.Aa?this.X[this.location&31]=this.ib[a&63]:this.r.pa&&(this.X[(this.location&63)>>1]=0==(this.location&1)?this.Ya[a]:this.X[(this.location&63)>>1]|this.qb[a&15])}this.kb=a;this.location++},Sc:function(a){192>=a?(0==this.Qa?(this.Qa=this.D[10],this.status|=4):this.Qa--,0!=(this.status&4)&&0!=(this.D[0]&16)&&(this.r.Q.na=h)):(this.Qa=this.D[10],0!=(this.status&128)&&0!=(this.D[1]&32)&&224>a&&(this.r.Q.na=h),a==this.r.Va-1&&(this.Pb=this.D[9]))},gd:function(){this.status|=
...
this.X[s+m];e++;0!=d&&23==k&&(f=a>>3,c=(a&7)<<3)}},zc:function(a){for(var b=this.Ja[a],c=Math.min(8,b[0]),d=this.D[1]&1,e=a<<8,f=3*c;0!=c--;){var g=b[f--]|(this.D[6]&4)<<6,k=b[f--],j=b[f--]-(this.D[0]&8),l=a-k>>d;0!=(this.D[1]&2)&&(g&=-2);g=this.nb[g+((l&8)>>3)];k=0;0>j&&(k=-j,j=0);l=k+((l&7)<<3);if(0==d)for(;8>k&&256>j;k++,j++){var m=g[l++];0!=m&&!this.Oa[j]&&(this.display[j+e]=this.X[m+16],this.ua[j]?this.status|=32:this.ua[j]=h)}else for(;8>k&&256>j;k++,j+=2)m=g[l++],0!=m&&!this.Oa[j]&&(this.display[j+
e]=this.X[m+16],this.ua[j]?this.status|=32:this.ua[j]=h),0!=m&&!this.Oa[j+1]&&(this.display[j+e+1]=this.X[m+16],this.ua[j+1]?this.status|=32:this.ua[j+1]=h)}8<=b[0]&&(this.status|=64)},wc:function(a){var b=this.X[16+(this.D[7]&15)],a=a<<8,c;for(c=0;256>c;c++)this.display[a++]=b},Hc:function(){var a,b,c,d;if(this.r.Aa&&!this.ib.length){this.ib=Array(64);for(a=0;64>a;a++)b=a&3,c=a>>2&3,d=a>>4&3,this.ib[a]=85*b|85*c<<8|85*d<<16}else if(this.r.pa&&!this.Ya.length){this.Ya=Array(256);this.qb=Array(16);
for(a=0;256>a;a++)c=a&15,d=a>>4&15,this.Ya[a]=d<<12|d<<8|c<<4|c;for(a=0;16>a;a++)this.qb[a]=a<<20}},jc:function(){for(var a=0;512>a;a++)this.nb[a]=Array(64)},qc:function(){for(var a=this.Ka;a<=this.Ba;a++)if(this.Ta[a]){this.Ta[a]=o;for(var b=this.nb[a],c=0,d=a<<5,e=0;8>e;e++)for(var f=this.P[d++],g=this.P[d++],k=this.P[d++],j=this.P[d++],l=128;0!=l;l>>=1){var m=0;0!=(f&l)&&(m|=1);0!=(g&l)&&(m|=2);0!=(k&l)&&(m|=4);0!=(j&l)&&(m|=8);b[c++]=m}}this.Ka=512;this.Ba=-1},pc:function(){this.oa=o;for(var a=
0;a<this.Ja.length;a++)this.Ja[a][0]=0;a=0==(this.D[1]&2)?8:16;1==(this.D[1]&1)&&(a<<=1);for(var b=0;64>b;b++){var c=this.P[this.$+b]&255;if(208==c)break;c++;240<c&&(c-=256);for(var d=0;192>d;d++)if(d>=c&&d-c<a){var e=this.Ja[d];if(8>e[0]){var f=3*e[0]+1,g=this.$+(b<<1)+128;e[f++]=this.P[g++]&255;e[f++]=c;e[f++]=this.P[g]&255;e[0]++}}}}};function t(a){this.r=a;this.enable=p();this.updateStatus=p();this.dc=p()}
