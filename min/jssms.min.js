...
*/
'use strict';var i=void 0,k=!0,aa=null,l=!1;function ba(){return function(){}}var ca=!(!window.DataView||!window.ArrayBuffer);function da(a){this.tb={ui:ea,swfPath:"lib/"};if("undefined"!=typeof a)for(var d in this.tb)"undefined"!=typeof a[d]&&(this.tb[d]=a[d]);this.T=new fa(this);this.Qa=new a.ui(this);this.w=new ga(this);this.wa=new ha(this);this.ports=new ia(this);this.D=new na(this);this.Qa.updateStatus("Ready to load a ROM.")}
da.prototype={Ia:l,Xa:0,L:0,rb:0,Da:0,Fa:0,Ka:l,ba:k,S:l,Na:k,Aa:[],Ba:0,Ma:0,xa:[],pb:0,ob:0,Ea:0,Cb:0,hb:"",ib:"",reset:function(){var a=this.w.lb,d=0;0==a||this.S?(this.Da=60,this.L=262,d=3579545):1==a&&(this.Da=50,this.L=313,d=3546893);this.Xa=Math.round(d/this.Da/this.L+1);this.w.lb=a;if(this.Na){a=this.wa;a.nb=(d<<8)/16/44100;a.M=0;a.G=0;a.la=16;a.V=32768;for(d=0;4>d;d++)a.C[d<<1]=1,a.C[(d<<1)+1]=15,a.A[d]=0,a.J[d]=1,3!=d&&(a.fa[d]=qa);this.Ma=Math.round(44100/this.Da);if(0==this.Aa.length||
this.Aa.length!=this.Ma)this.Aa=Array(this.Ma);if(0==this.xa.length||this.xa.length!=this.L){this.xa=Array(this.L);for(var g=0,d=0;d<this.L;d++)a=(this.Ma<<16)/this.L+g,g=a-(a>>16<<16),this.xa[d]=a>>16}}this.Cb=0;this.Fa=this.rb;this.T.reset();this.Qa.reset();this.w.reset();this.ports.reset();this.D.reset();ra(this.D,aa)},start:function(){var a=this;this.Ia||(this.Ia=k);this.Db=setInterval(function(){a.frame()},17);this.eb=aa;this.Ea=0;sa(this);this.Bb=setInterval(function(){sa(a)},500)},stop:function(){clearInterval(this.Db);
clearInterval(this.Bb);this.Ia=l},frame:function(){var a;for(a=0;a<this.L;a++){if(193==a){ta(this.D,this.Xa,8);var d=this.w;d.status|=128;ta(this.D,0,0)}else ta(this.D,this.Xa,0);this.Na&&(d=a,0==d&&(this.Ba=0),d=this.xa[d],this.Aa=this.wa.update(this.Ba,d),this.Ba+=d);this.w.ia=a;if(0==this.Fa&&192>a){var g=this.w,d=a;if(!g.m.S||!(24>d||168<=d)){for(var h=g.X.length;h--;)g.X[h]=l;if(0!=(g.t[1]&64)){if(-1!=g.ca){for(var h=g,j=h.ka;j<=h.ca;j++)if(h.ua[j]){h.ua[j]=l;for(var o=h.Pa[j],m=0,q=j<<5,t=0;8>
t;t++)for(var C=h.B[q++],s=h.B[q++],G=h.B[q++],B=h.B[q++],E=128;0!=E;E>>=1){var z=0;0!=(C&E)&&(z|=1);0!=(s&E)&&(z|=2);0!=(G&E)&&(z|=4);0!=(B&E)&&(z|=8);o[m++]=z}}h.ka=512;h.ca=-1}h=g;j=d;o=h.t[8];C=h.kb;16>j&&0!=(h.t[0]&64)&&(o=0);m=h.t[0]&128;q=32-(o>>3)+h.Ga;t=j+C>>3;27<t&&(t-=28);C=(j+(C&7)&7)<<3;s=j<<8;for(G=h.Ga;G<h.bb;G++){var oa=h.Va+((q&31)<<1)+(t<<6),B=h.B[oa+1],E=(B&8)<<1,z=(G<<3)+(o&7),V=0==(B&4)?C:56-C,oa=h.Pa[(h.B[oa]&255)+((B&1)<<8)];if(0==(B&2))for(var W=0;8>W&&256>z;W++,z++){var pa=
oa[W+V];h.pa[z]=0!=(B&16)&&0!=pa;h.display[z+s]=h.H[pa+E]}else for(W=7;0<=W&&256>z;W--,z++)pa=oa[W+V],h.pa[z]=0!=(B&16)&&0!=pa,h.display[z+s]=h.H[pa+E];q++;0!=m&&23==G&&(t=j>>3,C=(j&7)<<3)}if(g.R){h=g;h.R=l;for(j=0;j<h.ja.length;j++)h.ja[j][0]=0;j=0==(h.t[1]&2)?8:16;1==(h.t[1]&1)&&(j<<=1);for(o=0;64>o;o++){m=h.B[h.I+o]&255;if(208==m)break;m++;240<m&&(m-=256);for(q=0;192>q;q++)q>=m&&q-m<j&&(t=h.ja[q],8>t[0]&&(C=3*t[0]+1,s=h.I+(o<<1)+128,t[C++]=h.B[s++]&255,t[C++]=m,t[C++]=h.B[s]&255,t[0]++))}}if(0!=
g.ja[d][0]){h=g;j=d;o=h.ja[j];C=Math.min(8,o[0]);m=h.t[1]&1;q=j<<8;for(t=3*C;C--;)if(G=o[t--]|(h.t[6]&4)<<6,B=o[t--],s=o[t--]-(h.t[0]&8),E=j-B>>m,0!=(h.t[1]&2)&&(G&=-2),G=h.Pa[G+((E&8)>>3)],B=0,0>s&&(B=-s,s=0),E=B+((E&7)<<3),0==m)for(;8>B&&256>s;B++,s++)z=G[E++],0!=z&&!h.pa[s]&&(h.display[s+q]=h.H[z+16],h.X[s]?h.status|=32:h.X[s]=k);else for(;8>B&&256>s;B++,s+=2)if(z=G[E++],0!=z&&!h.pa[s]&&(h.display[s+q]=h.H[z+16],h.X[s]?h.status|=32:h.X[s]=k),0!=z&&!h.pa[s+1])h.display[s+q+1]=h.H[z+16],h.X[s+1]?
h.status|=32:h.X[s+1]=k;8<=o[0]&&(h.status|=64)}if(g.m.ba&&0!=(g.t[0]&32)){h=g.H[16+(g.t[7]&15)];d<<=8;if(32<16+(g.t[7]&15))debugger;if(49152<d)debugger;g.display[d++]=h;g.display[d++]=h;g.display[d++]=h;g.display[d++]=h;g.display[d++]=h;g.display[d++]=h;g.display[d++]=h;g.display[d]=h}}else{h=g.H[16+(g.t[7]&15)];d<<=8;j=i;for(j=0;256>j;j++)g.display[d++]=h}}}d=this.w;g=a;if(192>=g){if(0==d.ra?(d.ra=d.t[10],d.status|=4):d.ra--,0!=(d.status&4)&&0!=(d.t[0]&16))d.m.D.Q=k}else if(d.ra=d.t[10],0!=(d.status&
128)&&(0!=(d.t[1]&32)&&224>g)&&(d.m.D.Q=k),g==d.m.L-1)d.kb=d.t[9]}this.Ka&&(a=this.D,a.P=a.O,a.O=l,a.ha&&(a.b++,a.ha=l),a.push(a.b),a.b=102,a.l-=11,this.Ka=l);0==this.Fa--?(this.Fa=this.rb,a=k):a=l;a&&this.Qa.zb(this.w.display,[]);this.Ea++},fb:function(a,d){0!=d%1024&&(a=a.substr(512),d-=512);var g,h,j=Math.round(d/1024),o=Array(j);for(g=0;g<j;g++)if(o[g]=n(1024),ca)for(h=0;1024>h;h++)o[g].setUint8(h,a.charCodeAt(1024*g+h)&255);else for(h=0;1024>h;h++)o[g][h]=a.charCodeAt(1024*g+h)&255;return o}};
function ua(a,d,g){var h;h=".gg"===g.substr(-3).toLowerCase()?2:1;var j=d.length;1==h?(a.ba=k,a.S=l,a.w.Ga=0,a.w.bb=32,a.pb=256,a.ob=192):2==h&&(a.S=k,a.ba=l,a.w.Ga=5,a.w.bb=27,a.pb=160,a.ob=144);if(1024>=j)return l;h=a.fb(d,j);if(h==aa)return l;ra(a.D,h);a.hb=d;a.ib=g;return k}function sa(a){var d=+new Date,g="Running";a.eb&&(g+=": "+(a.Ea/((d-a.eb)/1E3)).toFixed(2)+" (/ "+(1E3/17).toFixed(2)+") FPS");a.Qa.updateStatus(g);a.Ea=0;a.eb=d};var n=ca?function(a){a===i&&(a=0);return new DataView(new ArrayBuffer(a))}:Array,ya=ca?function(a){if(a===i)return n();var d,g;d=a.byteLength;for(g=new n(d);d--;)g.setUint8(d,a.getUint8(d));return g}:function(a){if(a===i)return n();var d,g;d=a.length;for(g=new n(d);d--;)"undefined"!=typeof a[d]&&(g[d]=a[d]);return g},p=ca?function(a,d,g){a.U[d>>10].setUint8(d&1023,g);65532<=d&&a.page(d&3,g)}:function(a,d,g){a.U[d>>10][d&1023]=g;65532<=d&&a.page(d&3,g)},za=ca?function(a,d){return a[d>>10].getUint8(d&
1023)}:function(a,d){return a[d>>10][d&1023]},Ea=ca?function(a,d){return 1023>(d&1023)?a[d>>10].getUint16(d&1023,k):a[d>>10].getUint8(d&1023)|a[++d>>10].getUint8(d&1023)<<8}:function(a,d){return a[d>>10][d&1023]&255|(a[++d>>10][d&1023]&255)<<8};function Fa(a){var d=l;a.some(function(a){return a in document?(d=a,k):l});return d};var Ga=[4,10,7,6,4,4,7,4,4,11,7,6,4,4,7,4,8,10,7,6,4,4,7,4,12,11,7,6,4,4,7,4,7,10,16,6,4,4,7,4,7,11,16,6,4,4,7,4,7,10,13,6,11,11,10,4,7,11,13,6,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,7,7,7,7,7,7,4,7,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,4,4,4,4,4,4,7,4,5,10,10,10,10,11,7,11,5,10,10,0,10,17,7,11,5,10,10,11,10,11,7,11,5,4,10,11,10,0,7,11,5,10,10,
...
function na(a){this.m=a;this.port=a.ports;this.sa=this.k=this.b=0;this.Q=this.na=this.ha=this.P=this.O=l;this.l=this.xb=this.$a=this.a=this.Ha=this.ub=this.q=this.o=this.p=this.n=this.cb=this.ab=this.f=this.i=this.Za=this.Ya=this.g=this.h=this.Wa=this.Ua=this.d=this.e=this.Ta=this.c=this.ta=0;this.W=[];this.gb=Array(8);this.Oa=aa;this.yb=l;this.aa=Array(4);this.da=0;this.U=Array(65);this.F=Array(65);this.Ib=n(1024);this.Ra=[];this.za=[];this.j=[];this.Z=[];this.Y=[];this.v=[];this.u=[];this.oa=[];
var d,g,h,j,o,m;this.za=Array(256);this.j=Array(256);this.Z=Array(256);this.Y=Array(256);this.oa=Array(256);for(a=0;256>a;a++)d=0!=(a&128)?128:0,g=0==a?64:0,h=a&32,j=a&8,o=Ma(a)?4:0,this.za[a]=d|g|h|j,this.j[a]=d|g|h|j|o,this.Z[a]=d|g|h|j,this.Z[a]|=128==a?4:0,this.Z[a]|=0==(a&15)?16:0,this.Y[a]=d|g|h|j|2,this.Y[a]|=127==a?4:0,this.Y[a]|=15==(a&15)?16:0,this.oa[a]=0!=a?a&128:68,this.oa[a]|=h|j|16;this.v=Array(131072);this.u=Array(131072);a=0;d=65536;g=0;h=65536;for(o=0;256>o;o++)for(m=0;256>m;m++)j=
m-o,this.v[a]=0!=m?0!=(m&128)?128:0:64,this.v[a]|=m&40,(m&15)<(o&15)&&(this.v[a]|=16),m<o&&(this.v[a]|=1),0!=((j^o^128)&(j^m)&128)&&(this.v[a]|=4),a++,j=m-o-1,this.v[d]=0!=m?0!=(m&128)?128:0:64,this.v[d]|=m&40,(m&15)<=(o&15)&&(this.v[d]|=16),m<=o&&(this.v[d]|=1),0!=((j^o^128)&(j^m)&128)&&(this.v[d]|=4),d++,j=o-m,this.u[g]=0!=m?0!=(m&128)?130:2:66,this.u[g]|=m&40,(m&15)>(o&15)&&(this.u[g]|=16),m>o&&(this.u[g]|=1),0!=((j^o)&(o^m)&128)&&(this.u[g]|=4),g++,j=o-m-1,this.u[h]=0!=m?0!=(m&128)?130:2:66,this.u[h]|=
m&40,(m&15)>=(o&15)&&(this.u[h]|=16),m>=o&&(this.u[h]|=1),0!=((j^o)&(o^m)&128)&&(this.u[h]|=4),h++;this.Ra=Array(2048);for(a=256;a--;)for(d=0;1>=d;d++)for(g=0;1>=g;g++)for(h=0;1>=h;h++){j=this.Ra;o=d<<8|h<<9|g<<10|a;m=d|h<<1|g<<4;this.c=a;this.a=m;var q=this.c,t=0,C=m&1,s=C;if(0!=(m&16)||9<(q&15))t|=6;if(1==C||159<q||143<q&&9<(q&15))t|=96,s=1;153<q&&(s=1);0!=(m&2)?u(this,t):v(this,t);m=this.a&254|s;m=Ma(this.c)?m&251|4:m&251;j[o]=this.c|m<<8}for(a=this.c=this.a=0;65>a;a++)this.F[a]=n(1024),this.U[a]=
n(1024);for(a=0;8>a;a++)this.gb[a]=n(1024);this.Oa==aa&&(this.Oa=n(32),this.yb=l);this.F[64]=n(1024);this.U[64]=n(1024);this.da=2}
na.prototype={reset:function(){this.b=this.$a=this.a=this.Ha=this.ub=this.o=this.q=this.n=this.p=this.i=this.f=this.ab=this.cb=this.h=this.g=this.Ya=this.Za=this.e=this.d=this.Ua=this.Wa=this.c=this.Ta=0;this.k=57328;this.sa=this.xb=this.l=0;this.na=this.P=this.O=l;this.ta=0;this.ha=l},call:function(a){a?(this.push(this.b+2),this.b=w(this,this.b),this.l-=7):this.b+=2},push:function(a,d){if("undefined"===typeof d){var g=--this.k;p(this,g,a>>8);g=--this.k;p(this,g,a&255)}else g=--this.k,p(this,g,a),
g=--this.k,p(this,g,d)},page:function(a,d){var g,h;this.aa[a]=d;switch(a){case 0:if(0!=(d&8)){g=(d&4)<<2;for(h=32;48>h;h++)this.F[h]=ya(this.Oa[g]),this.U[h]=ya(this.Oa[g]),g++;this.yb=k}else{g=this.aa[3]%this.da<<4;for(h=32;48>h;h++)this.F[h]=ya(this.W[g++]),this.U[h]=n(1024)}break;case 1:g=(d%this.da<<4)+1;for(h=1;16>h;h++)this.F[h]=ya(this.W[g++]);break;case 2:g=d%this.da<<4;for(h=16;32>h;h++)this.F[h]=ya(this.W[g++]);break;case 3:if(0==(this.aa[0]&8)){g=d%this.da<<4;for(h=32;48>h;h++)this.F[h]=
ya(this.W[g++])}}}};function w(a,d){return Ea(a.F,d)}function x(a){return za(a.F,a.b)}function y(a,d){return za(a.F,d)}function ra(a,d){d!=aa&&(a.W=d);a.aa[0]=0;a.aa[1]=0;a.aa[2]=1;a.aa[3]=0;if(a.W!=aa){a.da=a.W.length/16;for(var g=0;48>g;g++)a.F[g]=ya(a.W[g&31]),a.U[g]=n(1024);for(g=48;64>g;g++)a.F[g]=a.gb[g&7],a.U[g]=a.gb[g&7]}else a.da=0}function Ma(a){var d=k,g;for(g=0;8>g;g++)0!=(a&1<<g)&&(d=!d);return d}
function Sa(a,d){var g=a.i<<8|a.f,h=g-d-(a.a&1);a.a=(g^h^d)>>8&16|2|h>>16&1|h>>8&128|(0!=(h&65535)?0:64)|((d^g)&(g^h)&32768)>>13;a.i=h>>8&255;a.f=h&255}function Ta(a,d){var g=a.i<<8|a.f,h=g+d+(a.a&1);a.a=(g^h^d)>>8&16|h>>16&1|h>>8&128|(0!=(h&65535)?0:64)|((d^g^32768)&(d^h)&32768)>>13;a.i=h>>8&255;a.f=h&255}function D(a,d,g){var h=d+g;a.a=a.a&196|(d^h^g)>>8&16|h>>16&1;return h&65535}function F(a,d){d=d-1&255;a.a=a.a&1|a.Y[d];return d}function H(a,d){d=d+1&255;a.a=a.a&1|a.Z[d];return d}
...
case 222:h=y(a,g)|8;p(a,g,h);break;case 230:h=y(a,g)|16;p(a,g,h);break;case 238:h=y(a,g)|32;p(a,g,h);break;case 246:h=y(a,g)|64;p(a,g,h);break;case 254:h=y(a,g)|128,p(a,g,h)}a.b++}function X(a,d){a.a=a.a&1|a.oa[d]}function fb(a,d){var g=d&1,d=d>>1&255;a.a=g|a.j[d];return d}function db(a,d){var g=d&1,d=d>>1|d&128;a.a=g|a.j[d];return d}function eb(a,d){var g=(d&128)>>7,d=(d<<1|1)&255;a.a=g|a.j[d];return d}function cb(a,d){var g=(d&128)>>7,d=d<<1&255;a.a=g|a.j[d];return d}
...
function ta(a,d,g){var h,j,o;a.l+=d;0!=d&&(a.xb=d);for(;a.l>g;){if(a.Q){var m=a;m.O&&!m.na&&((m.ha&&(m.b++,m.ha=l),m.O=m.P=l,m.Q=l,m.push(m.b),0==m.sa)?(m.b=0==m.ta||255==m.ta?56:m.ta,m.l-=13):1==m.sa?(m.b=56,m.l-=13):(m.b=w(m,(m.Ha<<8)+m.ta),m.l-=19))}j=y(a,a.b++);a.na=l;a.l-=Ga[j];switch(j){case 1:a.d=y(a,a.b++);a.e=y(a,a.b++);break;case 2:p(a,P(a),a.c);break;case 3:var q=a;q.d=q.d+1&255;0==q.d&&(q.e=q.e+1&255);break;case 4:a.e=H(a,a.e);break;case 5:a.e=F(a,a.e);break;case 6:a.e=y(a,a.b++);break;
case 7:var t=a,C=t.c>>7;t.c=t.c<<1&255|C;t.a=t.a&236|C;break;case 8:var s=a,G=s.c;s.c=s.Ta;s.Ta=G;G=s.a;s.a=s.$a;s.$a=G;break;case 9:Ya(a,D(a,N(a),P(a)));break;case 10:a.c=y(a,P(a));break;case 11:J(a);break;case 12:a.d=H(a,a.d);break;case 13:a.d=F(a,a.d);break;case 14:a.d=y(a,a.b++);break;case 15:var B=a,E=B.c&1;B.c=B.c>>1|E<<7;B.a=B.a&236|E;break;case 16:a.e=a.e-1&255;tb(a,0!=a.e);break;case 17:a.g=y(a,a.b++);a.h=y(a,a.b++);break;case 18:p(a,O(a),a.c);break;case 19:Va(a);break;case 20:a.h=H(a,a.h);
...
var pa=++h;p(a,pa,a.i);a.b+=2;break;case 35:K(a);break;case 36:a.i=H(a,a.i);break;case 37:a.i=F(a,a.i);break;case 38:a.i=y(a,a.b++);break;case 39:var ja=a,gb=ja.Ra[ja.c|(ja.a&1)<<8|(ja.a&2)<<8|(ja.a&16)<<6];ja.c=gb&255;ja.a=ja.a&2|gb>>8;break;case 40:tb(a,0!=(a.a&64));break;case 41:Ya(a,D(a,N(a),N(a)));break;case 42:h=w(a,a.b);a.f=y(a,h);a.i=y(a,h+1);a.b+=2;break;case 43:I(a);break;case 44:a.f=H(a,a.f);break;case 45:a.f=F(a,a.f);break;case 46:a.f=y(a,a.b++);break;case 47:var Ha=a;Ha.c^=255;Ha.a|=
...
break;case 215:a.push(a.b);a.b=16;break;case 216:sb(a,0!=(a.a&1));break;case 217:var ka=a,Na=ka.e;ka.e=ka.Ua;ka.Ua=Na;Na=ka.d;ka.d=ka.Wa;ka.Wa=Na;var la=a,Oa=la.h;la.h=la.Ya;la.Ya=Oa;Oa=la.g;la.g=la.Za;la.Za=Oa;var ma=a,Pa=ma.i;ma.i=ma.ab;ma.ab=Pa;Pa=ma.f;ma.f=ma.cb;ma.cb=Pa;break;case 218:ub(a,0!=(a.a&1));break;case 219:a.c=Z(a.port,y(a,a.b++));break;case 220:a.call(0!=(a.a&1));break;case 221:var e=a,mb=y(a,a.b++),va=i,Qa=i;e.l-=Ja[mb];switch(mb){case 9:Xa(e,D(e,M(e),P(e)));break;case 25:Xa(e,D(e,
...
a.b=56}}};function fa(a){this.m=a;this.Nb=this.Mb=this.ga=this.r=this.s=0;this.Lb=this.Kb=l}
fa.prototype={reset:function(){this.ga=this.r=this.s=255;this.Ka=l},keydown:function(a){switch(a.keyCode){case 38:this.s&=-2;break;case 40:this.s&=-3;break;case 37:this.s&=-5;break;case 39:this.s&=-9;break;case 88:this.s&=-17;break;case 90:this.s&=-33;break;case 13:this.m.ba?this.m.Ka=k:this.ga&=-129;break;case 104:this.r&=-2;break;case 98:this.r&=-3;break;case 100:this.r&=-5;break;case 102:this.r&=-9;break;case 103:this.r&=-17;break;case 105:this.r&=-33;break;case 97:this.r&=-65;break;default:return}a.preventDefault()},
keyup:function(a){switch(a.keyCode){case 38:this.s|=1;break;case 40:this.s|=2;break;case 37:this.s|=4;break;case 39:this.s|=8;break;case 88:this.s|=16;break;case 90:this.s|=32;break;case 13:this.m.ba||(this.ga|=128);break;case 104:this.r|=1;break;case 98:this.r|=2;break;case 100:this.r|=4;break;case 102:this.r|=8;break;case 103:this.r|=16;break;case 105:this.r|=32;break;case 97:this.r|=64;break;default:return}a.preventDefault()}};var qa=Number.MIN_VALUE,vb=[25,20,16,13,10,8,6,5,4,3,3,2,2,1,1,0];function ha(a){this.m=a;this.M=this.nb=0;this.C=Array(8);this.G=0;this.A=Array(4);this.J=Array(4);this.fa=Array(3);this.la=16;this.V=32768;this.ma=Array(4)}
...
1)),1==this.J[3]&&(this.V=this.V>>1|(0!=(this.C[6]&4)?0!=(this.V&9)&&0!=(this.V&9^9)?1:0:this.V&1)<<15))}return g}};function ga(a){this.m=a;this.lb=0;this.B=Array(16384);this.H=Array(32);for(a=0;32>a;a++)this.H[a]=0;this.t=Array(16);this.status=0;this.$=l;this.ra=this.ia=this.La=this.va=this.location=this.N=0;this.pa=Array(256);this.X=Array(256);this.kb=this.Va=0;this.display=Array(49152);this.Ja=[];this.ya=[];this.Sa=[];this.I=this.bb=this.Ga=0;this.R=l;this.ja=Array(192);for(a=0;192>a;a++)this.ja[a]=Array(25);this.Pa=Array(512);this.ua=Array(512);for(a=this.ca=this.ka=0;512>a;a++)this.Pa[a]=Array(64)}
ga.prototype={reset:function(){var a,d,g,h;if(this.m.ba&&!this.Ja.length){this.Ja=Array(64);for(a=0;64>a;a++)d=a&3,g=a>>2&3,h=a>>4&3,this.Ja[a]=85*d|85*g<<8|85*h<<16}else if(this.m.S&&!this.ya.length){this.ya=Array(256);this.Sa=Array(16);for(a=0;256>a;a++)g=a&15,h=a>>4&15,this.ya[a]=h<<12|h<<8|g<<4|g;for(a=0;16>a;a++)this.Sa[a]=a<<20}this.$=k;for(a=this.va=this.status=this.ra=this.location=0;16>a;a++)this.t[a]=0;this.t[2]=14;this.t[5]=126;this.kb=0;this.m.D.Q=l;this.R=k;this.ka=512;this.ca=-1;for(a=
0;16384>a;a++)this.B[a]=0;for(a=0;49152>a;a++)this.display[a]=0}};function wb(a){a.Va=(a.t[2]&14)<<10;a.ka=0;a.ca=511;for(var d=0,g=a.ua.length;d<g;d++)a.ua[d]=k;a.I=(a.t[5]&-130)<<7;a.R=k};function ea(a){this.m=a;this.enable=ba();this.updateStatus=ba();this.Hb=ba();this.zb=ba()}
"undefined"!==typeof $&&($.fn.Ab=function(a){function d(d){this.m=d;var j=this,d=$("<div></div>"),o=$('<div class="controls"></div>'),m=Fa(["fullscreenEnabled","mozFullScreenEnabled","webkitCancelFullScreen"]),q;this.mb=l;this.sb=Fa(["hidden","mozHidden","webkitHidden","msHidden"]);this.screen=$('<canvas width=256 height=192 class="screen"></canvas>');this.qa=this.screen[0].getContext("2d");if(this.qa.getImageData){this.Ca=this.qa.getImageData(0,0,256,192);this.Fb();this.wb=$("<div></div>");this.ea=
$("<select></select>");this.ea.change(function(){j.fb()});this.z={start:$('<input type="button" value="Stop" class="btn" disabled="disabled">'),vb:$('<input type="button" value="Restart" class="btn" disabled="disabled">'),jb:$('<input type="button" value="Enable sound" class="btn" disabled="disabled">'),zoom:$('<input type="button" value="Zoom in" class="btn">')};this.z.start.click(function(){j.m.Ia?(j.m.stop(),j.updateStatus("Paused"),j.z.start.attr("value","Start")):(j.m.start(),j.z.start.attr("value",
"Stop"))});this.z.vb.click(function(){""!==j.m.hb&&""!==j.m.ib&&ua(j.m,j.m.hb,j.m.ib)?(j.m.reset(),wb(j.m.w),j.m.start()):$(this).attr("disabled","disabled")});this.z.jb.click(ba());this.z.zoom.click(function(){j.mb?(j.screen.animate({width:"256px",height:"192px"},function(){$(this).removeAttr("style")}),j.z.zoom.attr("value","Zoom in")):(j.screen.animate({width:"512px",height:"384px"}),j.z.zoom.attr("value","Zoom out"));j.mb=!j.mb});m&&(this.z.Jb=$('<input type="button" value="Go fullscreen" class="btn">').click(function(){var a=
j.screen[0];a.requestFullscreen?a.requestFullscreen():a.mozRequestFullScreen?a.mozRequestFullScreen():a.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT)}));for(q in this.z)this.z.hasOwnProperty(q)&&this.z[q].appendTo(o);this.log=$('<div id="status"></div>');this.screen.appendTo(d);this.wb.appendTo(d);o.appendTo(d);this.log.appendTo(d);d.appendTo($(g));"undefined"!=typeof a&&this.Gb(a);$(document).bind("keydown",function(a){j.m.T.keydown(a)}).bind("keyup",function(a){j.m.T.keyup(a)})}else $(g).html('<div class="alert-message error"><p><strong>Oh no!</strong> Your browser doesn\'t support writing pixels directly to the <code>&lt;canvas&gt;</code> tag. Try the latest versions of Firefox, Google Chrome, Opera or Safari!</p></div>')}
var g=this;d.prototype={reset:function(){this.screen[0].width=256;this.screen[0].height=192;this.log.text("")},Fb:function(){this.qa.fillStyle="black";this.qa.fillRect(0,0,256,192);for(var a=3;a<=this.Ca.data.length-3;a+=4)this.Ca.data[a]=255},Gb:function(a){var d,g,m,q,t=0;this.ea.children().remove();$("<option>Select a ROM...</option>").appendTo(this.ea);for(d in a){if(a.hasOwnProperty(d)){g=$("<optgroup></optgroup>").attr("label",d);m=a[d].length;for(q=0;q<m;q++)$("<option>"+a[d][q][0]+"</option>").attr("value",
a[d][q][1]).appendTo(g);g.appendTo(this.ea)}t++}t&&this.ea.appendTo(this.wb)},fb:function(){var a=this;this.updateStatus("Downloading...");$.ajax({url:escape(this.ea.val()),xhr:function(){var d=$.ajaxSettings.xhr();"undefined"!==typeof d.overrideMimeType&&d.overrideMimeType("text/plain; charset=x-user-defined");return a.xhr=d},complete:function(d){ua(a.m,d.responseText,a.ea.val());a.m.reset();wb(a.m.w);a.m.start();a.enable();a.z.start.removeAttr("disabled")}})},enable:function(){this.z.vb.removeAttr("disabled");
this.m.Na?this.z.jb.attr("value","Disable sound"):this.z.jb.attr("value","Enable sound")},updateStatus:function(a){this.log.text(a)},Hb:ba(),zb:function(a){if(!this.sb||!document[this.sb]){var d=this.Ca.data,g,m,q;for(m=0;49152>=m;m++)g=a[m],q=4*m,d[q]=g&255,d[q+1]=g>>8&255,d[q+2]=g>>16&255;this.qa.putImageData(this.Ca,0,0)}}};return d});function ia(a){this.m=a;this.w=a.w;this.wa=a.wa;this.T=a.T;this.qb=64;this.Eb=0;this.K=[]}ia.prototype={reset:function(){this.K=Array(2)}};
function Z(a,d){if(a.m.S&&7>d)switch(d){case 0:return a.T.ga&191|a.qb;case 1:case 2:case 3:case 4:case 5:return 0;case 6:return 255}switch(d&193){case 64:var g;a:{g=a.w;if(0==g.lb){if(218<g.ia){g=g.ia-6;break a}}else if(242<g.ia){g=g.ia-57;break a}g=g.ia}return g;case 65:return a.Eb;case 128:g=a.w;g.$=k;var h=g.La;g.La=g.B[g.location++&16383]&255;return h;case 129:return g=a.w,g.$=k,h=g.status,g.status=0,g.m.D.Q=l,h;case 192:return a.T.s;case 193:return a.T.r&63|a.K[0]|a.K[1]}return 255}
function Y(a,d,g){if(!(a.m.S&&7>d))switch(d&193){case 1:a.K[0]=(g&32)<<1;a.K[1]=g&128;0==a.qb&&(a.K[0]=~a.K[0],a.K[1]=~a.K[1]);break;case 128:a=a.w;a.$=k;switch(a.va){case 0:case 1:case 2:d=a.location&16383;if(g!=(a.B[d]&255)){if(d>=a.I&&d<a.I+64)a.R=k;else if(d>=a.I+128&&d<a.I+256)a.R=k;else{var h=d>>5;a.ua[h]=k;h<a.ka&&(a.ka=h);h>a.ca&&(a.ca=h)}a.B[d]=g}break;case 3:a.m.ba?a.H[a.location&31]=a.Ja[g&63]:a.m.S&&(a.H[(a.location&63)>>1]=0==(a.location&1)?a.ya[g]:a.H[(a.location&63)>>1]|a.Sa[g&15])}a.La=
g;a.location++;break;case 129:a=a.w;if(a.$)a.$=l,a.N=g,a.location=a.location&16128|g;else if(a.$=k,a.va=g>>6&3,a.location=a.N|g<<8,0==a.va)a.La=a.B[a.location++&16383]&255;else if(2==a.va){g&=15;switch(g){case 0:0!=(a.status&4)&&(a.m.D.Q=0!=(a.N&16));break;case 1:0!=(a.status&128)&&0!=(a.N&32)&&(a.m.D.Q=k);(a.N&3)!=(a.t[g]&3)&&(a.R=k);break;case 2:a.Va=(a.N&14)<<10;break;case 5:d=a.I,a.I=(a.N&-130)<<7,d!=a.I&&(a.R=k)}a.t[g]=a.N}break;case 64:case 65:a.m.Na&&a.wa.write(g)}};window.JSSMS=da;jQuery.fn.JSSMSUI=jQuery.fn.Ab;
