...
declarations:[{type:"VariableDeclarator",id:{type:"Identifier",name:a},init:b}],kind:"var"}},Identifier:function(a){return{type:"Identifier",name:a}},Literal:function(a){return DEBUG&&"number"==typeof a?{type:"Literal",value:a,raw:JSSMS.Utils.toHex(a)}:{type:"Literal",value:a}},CallExpression:function(a,b){void 0==b&&(b=[]);Array.isArray(b)||(b=[b]);return{type:"CallExpression",callee:n.Identifier(a),arguments:b}},AssignmentExpression:function(a,b,c){return{type:"AssignmentExpression",operator:a,
left:b,right:c}},BinaryExpression:function(a,b,c){return{type:"BinaryExpression",operator:a,left:b,right:c}},UnaryExpression:function(a,b){return{type:"UnaryExpression",operator:a,argument:b}},MemberExpression:function(a,b){return{type:"MemberExpression",computed:!0,object:a,property:b}},ConditionalExpression:function(a,b,c){return{type:"ConditionalExpression",test:a,consequent:b,alternate:c}},LogicalExpression:function(a,b,c){return{type:"LogicalExpression",operator:a,left:b,right:c}},Register:function(a){return{type:"Register",
name:a}},Bit:function(a){return n.Literal(BIT_TABLE[a])}},o={SET16:function(a,b,c){if("Literal"==c.type){var e=evaluate(n.BinaryExpression(">>",c,n.Literal(8)));c=evaluate(n.BinaryExpression("&",c,n.Literal(255)));return[n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),e)),n.ExpressionStatement(n.AssignmentExpression("=",n.Register(b),c))]}return[n.VariableDeclaration("val",c),n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.BinaryExpression(">>",n.Identifier("val"),
n.Literal(8)))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register(b),n.BinaryExpression("&",n.Identifier("val"),n.Literal(255))))]},EX:function(a,b){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("temp"),n.Register(a))),n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.Identifier(a+"2"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier(a+"2"),n.Identifier("temp"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier("temp"),n.Register(b))),
n.ExpressionStatement(n.AssignmentExpression("=",n.Register(b),n.Identifier(b+"2"))),n.ExpressionStatement(n.AssignmentExpression("=",n.Identifier(b+"2"),n.Identifier("temp")))]},NOOP:function(){return function(){}},LD8:function(a,b,c){return void 0==b&&void 0==c?function(b){return n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.Literal(b)))}:"i"==b&&void 0==c?function(){return[n.ExpressionStatement(n.AssignmentExpression("=",n.Register(a),n.Register("i"))),n.ExpressionStatement(n.AssignmentExpression("=",
...
a.left.name)&&(a.left=e[a.left.name]));return a});return a})}};return a}();var Generator=function(){function a(a){return JSSMS.Utils.traverse(a,function(a){"Register"==a.type&&(a.type="Identifier");return a})}var b=JSSMS.Utils.toHex,c="page temp location val value JSSMS.Utils.rndInt".split(" "),e=function(){this.ast=[]};e.prototype={generate:function(d){JSSMS.Utils.console.time("Generating");for(var e=0;e<d.length;e++)d[e]=d[e].map(function(d){var e=[],g=d[0].address,l=0;d=d.map(function(a){null==a.ast&&(a.ast=[]);if(ENABLE_SERVER_LOGGER)var c={type:"ExpressionStatement",
expression:{type:"CallExpression",callee:n.Identifier("sync"),arguments:[]}};var d=l,e=a.opcode,f=0;switch(e[0]){case 203:f=OP_CB_STATES[e[1]];break;case 221:case 253:f=2==e.length?OP_DD_STATES[e[1]]:OP_INDEX_CB_STATES[e[2]];break;case 237:f=OP_ED_STATES[e[1]];break;default:f=OP_STATES[e[0]]}l=d+f;d=[{type:"ExpressionStatement",expression:{type:"AssignmentExpression",operator:"-=",left:{type:"Identifier",name:"tstates"},right:{type:"Literal",value:l}}}];l=0;DEBUG&&(d[0].expression.right.raw=b(d[0].expression.right.value));
ENABLE_SERVER_LOGGER&&(d=[].concat(c,d));a.ast=[].concat(d,a.ast);null!=a.nextAddress&&(c={type:"ExpressionStatement",expression:{type:"AssignmentExpression",operator:"=",left:{type:"Identifier",name:"pc"},right:{type:"BinaryExpression",operator:"+",left:{type:"Literal",value:a.nextAddress%16384},right:{type:"BinaryExpression",operator:"*",left:{type:"Identifier",name:"page"},right:{type:"Literal",value:16384}}}}},DEBUG&&(c.expression.right.left.raw=b(c.expression.right.left.value),c.expression.right.right.right.raw=
"0x4000"),a.ast.push(c));DEBUG&&a.ast[0]&&(a.ast[0].leadingComments=[{type:"Line",value:" "+a.label}]);return a.ast});d.forEach(function(a){e=e.concat(a)});e=a(e);e=JSSMS.Utils.traverse(e,function(a){a.type&&("Identifier"==a.type&&-1==c.indexOf(a.name))&&(a.name="this."+a.name);return a});return DEBUG?{type:"Program",body:[{type:"FunctionDeclaration",id:{type:"Identifier",name:g},params:[{type:"Identifier",name:"page"},{type:"Identifier",name:"temp"},{type:"Identifier",name:"location"}],defaults:[],
body:{type:"BlockStatement",body:e},rest:null,generator:!1,expression:!1}]}:{type:"Program",body:e,comments:[{type:"Line",value:g}]}});JSSMS.Utils.console.timeEnd("Generating");this.ast=d}};return e}();var Recompiler=function(){var a=JSSMS.Utils.toHex,b=function(a){this.cpu=a;this.rom=[];this.options={};this.parser={};this.analyzer=new Analyzer;this.optimizer=new Optimizer;this.generator=new Generator;this.bytecodes={}};b.prototype={setRom:function(a){this.rom=a;this.parser=new Parser(a,this.cpu.frameReg)},reset:function(){var b=this;this.options.entryPoints=[{address:0,romPage:0,memPage:0},{address:56,romPage:0,memPage:0},{address:102,romPage:0,memPage:0}];2>=this.rom.length?JSSMS.Utils.console.log("Parsing full ROM"):
